...
public class FundBank extends BaseEntity {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1259511111437522430L;
		//alias
		...
		public static final String ALIAS_VERSION = "充值版本 1:企業版 0:個人版 null:無區分";
		public static final String ALIAS_DISPLAY = "是否顯示 Y:顯示 N:隱藏";
		...
		public static String getAliasDisplay() {
		...
		public String toString() {
			return new ToStringBuilder(this).append("Id", getId()).append("Logo", getLogo()).append("Name", getName())
					...
					.append("Returnscope", getRtnStruc()).append("Returnamt", getRtnSet()).append("MoveQuickType",getMoveQuickType())
					.append("MoveQuickDeposit",getMoveQuickDeposit()).append("MoveDeposit",getMoveDeposit())
					.append("version", getVersion()).append("display", getDisplay()).toString();
		}
		...
		public int hashCode() {
			return new HashCodeBuilder().append(getId()).append(getLogo()).append(getName()).append(getCode())
					...
					.append(getViplowlimit()).append(getRtnMin()).append(getRtnStruc()).append(getRtnSet()).append(getMoveQuickType())
					.append(getMoveQuickDeposit()).append(getMoveDeposit())
					.append(getVersion()).append(getDisplay()).toHashCode();
		}
		...
		public boolean equals(Object obj) {
			...
			.append(getDisplay(), other.getDisplay())
