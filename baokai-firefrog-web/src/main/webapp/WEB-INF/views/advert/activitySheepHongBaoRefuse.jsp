						...
						<div class="ui-tab">
							...
							<ul class="ui-form">
									<li>
										...
										<span class="ico-tab ico-tab-item ico-tab-current"><a href="${currentContextPath}/adAdmin/queryActivitySheepHongBao?pageStatus=3">未通过</a></span>
									</li>
								</ul>
							
							
						<form action="queryActivitySheepHongBao?pageStatus=3" method="post" id="J-search-form">
						<ul class="ui-search" id="J-search-panel">
                            ...
                            <input type="hidden" id="channelBK"  name ="channelBK" value="${status}"/>	
								...
								<select id="channel" style="width:90px;" name="status" class="ui-select">
									...
									<option value="4">web4.0</option>									</select>
							</li>
							
							
							<li>
								<input id="btsubmit" class="btn btn-primary" type="submit" value="搜 索">
								<a id="J-download-submit" class="btn btn-important" href="${fromGame}/gameoa/exportActivitySheepHongBao?pageStatus=3">导出报表<b class="btn-inner"></b></a>
