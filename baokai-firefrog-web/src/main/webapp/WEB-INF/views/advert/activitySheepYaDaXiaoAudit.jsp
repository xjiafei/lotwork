							...
							<div class="ui-tab-content ui-tab-content-current">
								<ul class="ui-form">
									<li>
										...
										<span class="ico-tab ico-tab-item ico-tab-current"><a href="${currentContextPath}/adAdmin/queryActivityYaDaXiaoLog?pageStatus=3">待审核（${unCheckNum}）</a></span>
								...
								<form action="queryActivityYaDaXiaoLog?pageStatus=3" id="J-form" method="post">
									...
									<li>
										...
										<li>
											...
											<a id="J-download-submit" class="btn btn-important" href="${fromGame}/gameoa/exportActivityYaDaXiaoLog?pageStatus=3">导出报表<b class="btn-inner"></b></a>
										</li>
									</ul>
								</form>
								...
								<table class="table table-info">
									...
									<c:forEach items="${struc}" var="struc" varStatus="configIndex">
										<tr data-id="${struc.id }">
											...
											<td>
											<permission:hasRight moduleName="MARKET_ACTIVITY_AUDITACTIVITYYADAXIAO">
...
<script type="text/javascript" src="${staticFileContextPath}/static/js/advert/sheepYaDaXiaoAudit.js"></script>
