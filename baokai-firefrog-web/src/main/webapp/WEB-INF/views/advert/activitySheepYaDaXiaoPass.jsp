							...
							<div class="ui-tab-content ui-tab-content-current">
								<ul class="ui-form">
									<li>
										...
										<span class="ico-tab ico-tab-item ico-tab-current"><a href="${currentContextPath}/adAdmin/queryActivityYaDaXiaoLog?pageStatus=4">已通过</a></span>
										<span class="ico-tab ico-tab-item"><a href="${currentContextPath}/adAdmin/queryActivityYaDaXiaoLog?pageStatus=5">未通过</a></span>
									</li>
								</ul>
								
								<form action="queryActivityYaDaXiaoLog?pageStatus=4" id="J-form" method="post">
									...
									<li>
										...
										<li>
											...
											<a id="J-download-submit" class="btn btn-important" href="${fromGame}/gameoa/exportActivityYaDaXiaoLog?pageStatus=4">导出报表<b class="btn-inner"></b></a>
										</li>
									</ul>
								</form>
