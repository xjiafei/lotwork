...
<body>
			<div class="col-crumbs">
                <div class="crumbs">
                    <strong>当前位置：</strong>
                    <a href="${currentContextPath}/adAdmin/queryPublishAdPage">营销中心</a> &gt; 专题管理(发布)
                </div>
            </div>
						...
						<table class="table table-info table-group" id="J-table">
							<thead>
								<tr>
									...
									<th>活动链接</th>
									<th>创建时间</th>
									<permission:hasRight moduleName="MARKET_MODIFYSUBJECT">
									<th>操作</th>
									</permission:hasRight>
								</tr>
							</thead>
							<tbody>
								...
								<tr>
									...
									<permission:hasRight moduleName="MARKET_MODIFYSUBJECT">
									<td class="table-tool">
										<a class="ico-edit" title="修改" href="${currentContextPath }/adAdmin/goModifyTopic?id=${list.id}"></a>
									</td>
									</permission:hasRight>
								</tr>
								</c:forEach>
