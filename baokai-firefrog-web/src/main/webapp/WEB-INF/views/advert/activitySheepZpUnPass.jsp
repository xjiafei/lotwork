							...
							<div class="ui-tab-content ui-tab-content-current">
								<ul class="ui-form">
									<li>
										...
										<span class="ico-tab ico-tab-item ico-tab-current"><a href="${currentContextPath}/adAdmin/queryActivityZpLog?pageStatus=5">未通过</a></span>
									</li>
								</ul>
								
								<form action="queryActivityZpLog?pageStatus=5" id="J-form" method="post">
									...
									<li>
										...
										<li>
											...
											<a id="J-download-submit" class="btn btn-important" href="${fromGame}/gameoa/exportActivityZpLog?pageStatus=5">导出报表<b class="btn-inner"></b></a>
										</li>
									</ul>
								</form>
