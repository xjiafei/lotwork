...
<head>
	<meta charset="UTF-8">
	<title>3.1.1系统-通知任务管理-系统任务--站内信模板编辑</title>
	<style>
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/notice/innerMsgTemplate.js"></script>
	
</head>
<body>
			<div class="col-crumbs"><div class="crumbs"><strong>当前位置：</strong><a href="${currentContextPath}/noticeAdmin/goSysMsgManager/">通知中心</a> &gt; <a href="${currentContextPath}/noticeAdmin/queryNoticeTask">通知任务管理</a> &gt; 站内信模板编辑</div></div>
			<div class="col-content">
				<div class="col-main">
					<div class="main">
						<h3 class="ui-title">站内信发送模板</h3>
						<form action="${currentContextPath}/noticeAdmin/saveInnerMsgTemp" id="J-form" method="post">
						<ul class="ui-form">
							<li>
								<label for="" class="ui-label">主题：</label>
								<input id="J-input-title" type="text" class="input w-4" value="${task.innerMsgTitle }" name="title">
							...
							<li>
								...
								<div class="textarea" style="width:60%">
									<textarea id="J-content"  rows="12" cols="80" style="width:100%;height:300px;" name="temp">${task.innerMsgTemp }</textarea>
								</div>
