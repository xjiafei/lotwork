...
<head>
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/acl/addSubGroup.js"></script>
</head>
<body>
			<div class="col-crumbs">
                <div class="crumbs">
                    ...
                    <a href="${currentContextPath}/aclAdmin/queryAclGroup?userId=${sessionScope.info.id}">权限组管理</a> &gt; 增加子组
                </div>
            </div>
					...
					<div class="main">
						...
						<ul class="ui-form">
							<li>
								...
								<input id="input-group-title" type="text" value="" class="input w-4" />
								<span class="ui-text-prompt">2-20位字符组成</span>
							</li>
							<li>
								<label class="ui-label" for="">父级组：</label>
								<span class="ui-singleline">${pname}</span>
