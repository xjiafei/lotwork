...
public class FundChangeLog2Service {
	...
	* @param fundOrder
	*/
	//@Transactional(rollbackFor = Exception.class,propagation=Propagation.NOT_SUPPORTED, isolation = Isolation.READ_COMMITTED,timeout=20)
	public String logFundChange(UserFund beforeFund, UserFund afterFund, String sn, BaseUser user, EnumItem item,
			Long isVisiblebyFrontUser, String exCode, String planCode, String note) {
