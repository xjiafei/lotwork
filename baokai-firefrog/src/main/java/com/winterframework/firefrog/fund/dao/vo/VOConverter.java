...
public class VOConverter {
	...
	*/
	public static UserFund fund2UserFund(Fund fund) {
		...
		// 這邊不能直接 fund.getDisableAmt() > fund.getBal() fund.getBal()? :fund.getDisableAmt()  流程上會有問題
	...
	public static FundCharge transFundChargeOrder2FundCharge(FundChargeOrder order) {
		...
		fundCharge.setChargeCardNum(order.getBankNumber());
		fundCharge.setChargeMode(order.getChargeMode());
		return fundCharge;
	}
	...
	public static FundCharge transFundChargeOrder2FundChargeUpdate(FundChargeOrder order) {
		...
		fundCharge.setOperatingTime(order.getOperatingTime());
		fundCharge.setBreakUrl(order.getBreakUrl());
		return fundCharge;
	}
	...
	public static FundChargeOrder transFundCharge2FundChargeOrder(FundCharge fundCharge) {
		...
		order.setOperatingTime(fundCharge.getOperatingTime());
		order.setBreakUrl(fundCharge.getBreakUrl());
		order.setChargeCardNum(fundCharge.getChargeCardNum());
		order.setBankAccount(fundCharge.getAccount());
		order.setChargeMode(fundCharge.getChargeMode());
		return order;
	}
	...
	* @return
	...
	public static FundWithdrawOrder fundWithdrawTOFundWithdrawOrder(FundWithdraw fundWithdraw) {
		...
		//order.setApprTime(fundWithdraw.getApprTime());
		order.setApprTime(fundWithdraw.getAppr2Time()==null?fundWithdraw.getApprTime():fundWithdraw.getAppr2Time());
		order.setMcNoticeTime(fundWithdraw.getMcNoticeTime());
		order.setApplyAccount(fundWithdraw.getApplyAccount());
		//		BankCard card = null;
		...
		order.setWithdrawMode(fundWithdraw.getWithdrawMode());
		order.setRootSn("");
		if(null != fundWithdraw.getRootSn()){
			order.setRootSn(fundWithdraw.getRootSn());
		}
		order.setTotalDrawAmount(fundWithdraw.getTotalDrawAmount());
		order.setSeperateCount(fundWithdraw.getSeperateCount());
		order.setIsSeperate(fundWithdraw.getIsSeperate());
		...
		order.setCancelAcct(fundWithdraw.getCancelAcct());
		order.setCancelTime(fundWithdraw.getCancelTime());
		
		//mow API  Response 狀態專用 
		order.setCompanyOrderNum(fundWithdraw.getCompanyOrderNum());
		order.setMownecumOrderNum(fundWithdraw.getMownecumOrderNum());
		order.setMowApiStatus(fundWithdraw.getMowApiStatus());
		order.setAmount(fundWithdraw.getAmount());
		order.setMowDetail(fundWithdraw.getMowDetail());
		order.setExactTransactionCharge(fundWithdraw.getExactTransactionCharge());
		order.setMd5Key(fundWithdraw.getMd5Key());
		order.setMowApiErrorMsg(fundWithdraw.getMowApiErrorMsg());
		order.setOperatingTime(fundWithdraw.getOperatingTime());
		return order;
	}
	...
	*/
	public static UserBank bankCard2UserBank(BankCard bc) {
		...
		ub.setBindcardType(bc.getBindcardType());
		ub.setNickName(bc.getNickName());
		ub.setId(bc.getId());
	...
	*/
	public static BankCard userBank2BankCard(UserBank ub) {
		...
		bc.setBindcardType(ub.getBindcardType());
		bc.setNickName(ub.getNickName());
		bc.setGmtModified(ub.getGmtModified());
		return bc;
	}
	...
	public static UserCardBindHistory UserCardBindHistoryRecordVO2UserCardBindHistoryRecord(
		...
		historyRecord.setNickName(vo.getNickName());
		historyRecord.setBindcardType(vo.getBindcardType());
	...
	public static UserCardBindHistoryRecordVO UserCardBindHistoryRecord2UserCardBindHistoryRecordVO(
		...
		vo.setBindcardType(historyRecord.getBindcardType());
		vo.setNickName(historyRecord.getNickName());
		return vo;
	}
	...
	public static WithdrawAppeal transVo2WithdrawAppeal(WithdrawAppealVO vo) {
		WithdrawAppeal withdrawAppeal = new WithdrawAppeal();			
		withdrawAppeal.setCardStr(vo.getUserBankStruc());
		UserBankStruc struc = JsonMapper.nonDefaultMapper().fromJson(withdrawAppeal.getCardStr(), UserBankStruc.class);
		withdrawAppeal.setUserBankStruc(struc);
		withdrawAppeal.setWithdrawSn(vo.getWithdrawSn());
		withdrawAppeal.setId(vo.getId());
		withdrawAppeal.setUserId(vo.getUserId());
		withdrawAppeal.setSn(vo.getSn());
		withdrawAppeal.setWithdrawAmt(vo.getWithdrawAmt());
		withdrawAppeal.setApplyTime(vo.getApplyTime());
		withdrawAppeal.setAppealStatus(vo.getAppealStatus());
		withdrawAppeal.setAppealMemo(vo.getAppealMemo());	
		withdrawAppeal.setAppealStatus(vo.getAppealStatus());
		withdrawAppeal.setUploadImages(vo.getUploadImages());
		withdrawAppeal.setAppealTips(vo.getAppealTips());
		withdrawAppeal.setAppealTipsResult(vo.getAppealTipsResult());
		return withdrawAppeal;
	}
	
	public static WithdrawAppeal transWithdrawVO2WithdrawAppeal(WithdrawAppealVO vo) {
		WithdrawAppeal withdrawAppeal = new WithdrawAppeal();			
		...
		withdrawAppeal.setWithdrawAmt(vo.getWithdrawAmt());
		withdrawAppeal.setApplyTime(vo.getApplyTime());
		withdrawAppeal.setBankId(vo.getBankId());
		withdrawAppeal.setCardNumber(vo.getCardNumber());
		withdrawAppeal.setAppealMemo(vo.getAppealMemo());	
		withdrawAppeal.setAppealStatus(vo.getAppealStatus());
		withdrawAppeal.setAppealTips(vo.getAppealTips());
		withdrawAppeal.setUploadImages(vo.getUploadImages());
		withdrawAppeal.setIsSeperate(vo.getIsSeperate());
		return withdrawAppeal;
	}
	
	public static WithdrawAppeal transVo2Appeal(WithdrawAppealVO vo) {
		WithdrawAppeal withdrawAppeal = new WithdrawAppeal();			
		withdrawAppeal.setId(vo.getId());
		withdrawAppeal.setUserId(vo.getUserId());
		withdrawAppeal.setAppealSn(vo.getAppealSn());
		withdrawAppeal.setWithdrawAmt(vo.getWithdrawAmt());
		withdrawAppeal.setWithdrawTime(vo.getWithdrawTime());
		withdrawAppeal.setVipLvl(vo.getVipLvl());
		withdrawAppeal.setUserName(vo.getUserName());
		withdrawAppeal.setAppealStatus(vo.getAppealStatus());
		withdrawAppeal.setAppealAcct(vo.getAppealAcct());
		withdrawAppeal.setAppealTime(vo.getAppealTime());
		withdrawAppeal.setBankId(vo.getBankId());
		withdrawAppeal.setBankName(vo.getBankName());
		withdrawAppeal.setCardNumber(vo.getCardNumber());
		withdrawAppeal.setAppealMemo(vo.getAppealMemo());	
		withdrawAppeal.setArgueTime(vo.getArgueTime());
		withdrawAppeal.setArgueAcct(vo.getArgueAcct());
		withdrawAppeal.setWithdrawSn(vo.getWithdrawSn());
		withdrawAppeal.setIsAppeal(vo.getIsAppeal());
		withdrawAppeal.setAppealTips(vo.getAppealTips());
		withdrawAppeal.setUploadImages(vo.getUploadImages());
		withdrawAppeal.setAppealTipsResult(vo.getAppealTipsResult());
		return withdrawAppeal;
