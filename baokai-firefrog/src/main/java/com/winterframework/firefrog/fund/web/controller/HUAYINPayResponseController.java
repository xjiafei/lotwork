...
@Controller("HUAYINPayResponseController")
@RequestMapping(value = "/fund/huayinpay/")
public class HUAYINPayResponseController {
	private static Logger logger = LoggerFactory
			.getLogger(HUAYINPayResponseController.class);
	...
	@PropertyConfig(value = "huayinpay_public_key")
	private String huayinpayPublicKey;
	...
	public String chargeConfirm(DDBPayConfirmRequest chargeConfirmRequest) {
		logger.info("=/fund/huayinpay/chargeConfirm Start:");
