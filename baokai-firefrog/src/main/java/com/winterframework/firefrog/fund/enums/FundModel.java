...
public class FundModel {
	...
	public enum FD implements EnumModel {
		...
		public enum AUTO implements EnumFunction {
			...
			public enum ITEMS implements EnumItem {
				//自动充值  充值中，订单关闭，充值成功
				AUTO(FD.DEFAULT, "ADAL", null, 1, MethodEnum.None), 
				CLOSED(FD.DEFAULT, "ADAL", null, 2, MethodEnum.None), 
				SUCCESS(FD.DEFAULT, "ADAL", null, 3, MethodEnum.addAmt);
	...
	public enum GM implements EnumModel {
		...
		public enum RSXX implements EnumFunction {
			...
			public enum ITEMS implements EnumItem {
				...
				RDWX(GM.DEFAULT, "RDWX", null, 4, MethodEnum.addAmtWithBal),
				RDXX(GM.DEFAULT, "RDXX", null, 5, MethodEnum.addAmtWithBal);
	...
	public enum PM implements EnumModel {
		...
		public enum PGFX implements EnumFunction {
			;
			public enum ITEMS implements EnumItem {
				PGFX(PM.DEFAULT, "PGFX", null, 1, MethodEnum.addAmtWithOtherBal);
				private ITEMS(EnumModel model, String summaryCode, String tradeCode, Integer status, MethodEnum me) {
					this.model = model;
					////this.tradeCode = tradeCode;
					this.summaryCode = summaryCode;
	...
	public enum TF implements EnumModel {
		...
		public enum TAIX implements EnumFunction {
			...
			public enum ITEMS implements EnumItem {
				...
				TFTX(TF.DEFAULT, "TFTX", null, 5, MethodEnum.reduceAmt),
				TXTM (TF.DEFAULT, "TXTM", null, 6, MethodEnum.addAmtWithBal),
				TFTG(TF.DEFAULT, "TFTG", null, 7, MethodEnum.reduceAmt),
				TGTM (TF.DEFAULT, "TGTM", null, 8, MethodEnum.addAmtWithOtherBal);
	...
	public enum OT implements EnumModel {
		...
		public enum DAXX implements EnumFunction {
			;
			public enum ITEMS implements EnumItem {
				PROCESS(OT.DEFAULT, "DAXX", null, 1, MethodEnum.None),
				REJECTED(OT.DEFAULT, "DAXX", null, 2,MethodEnum.None),
				SUCCESS(OT.DEFAULT, "DAXX", "DVCM", 3, MethodEnum.reduceAmt);
				private ITEMS(EnumModel model, String summaryCode, String tradeCode, Integer status, MethodEnum me) {
					this.model = model;
					//this.tradeCode = tradeCode;
					this.summaryCode = summaryCode;
		...
		public enum RBAP implements EnumFunction {
			;
			public enum ITEMS implements EnumItem {
				PROCESS(OT.DEFAULT, "RBAP", null, 1, MethodEnum.None), REJECTED(OT.DEFAULT, "RBAP", null, 2,
						MethodEnum.None), SUCCESS(OT.DEFAULT, "RBAP", null, 3, MethodEnum.addAmtWithBal);
				private ITEMS(EnumModel model, String summaryCode, String tradeCode, Integer status, MethodEnum me) {
					this.model = model;
					////this.tradeCode = tradeCode;
					this.summaryCode = summaryCode;
	...
	public enum AP implements EnumModel {
		DEFAULT;
		public enum ITEMS implements EnumItem {
			STK(AP.DEFAULT, "STK", "STK", 1, MethodEnum.None),
			SCZ(AP.DEFAULT, "SCZ", "SCZ", 2, MethodEnum.None);
			private ITEMS(EnumModel model, String summaryCode,
					String tradeCode, Integer status, MethodEnum me) {
				this.model = model;
				this.summaryCode = summaryCode;
				this.status = status;
				this.me = me;
