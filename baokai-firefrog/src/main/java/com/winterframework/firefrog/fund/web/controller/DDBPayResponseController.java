...
@Controller("DDBPayResponseController")
@RequestMapping(value = "/fund/ddbpay/")
public class DDBPayResponseController {
	private static Logger logger = LoggerFactory
			.getLogger(DDBPayResponseController.class);
	...
	@PropertyConfig(value = "ddbpay_public_key")
	private String ddbpayPublicKey;
	...
	public String chargeConfirm(DDBPayConfirmRequest chargeConfirmRequest) {
		logger.info("=/fund/ddbpay/chargeConfirm Start:");
