...
public class FundModelTool {
	...
	// 20150528 
		addItem(ss, FundModel.PM.PGPT.ITEMS.values());
		addItem(ss, FundModel.PM.PGAP.ITEMS.values());
		
		
		addItem(ss, FundModel.GM.DDPT.ITEMS.values());
		addItem(ss, FundModel.GM.DDAX.ITEMS.values());
//
		...
		addItem(ss, FundModel.PM.PGFX.ITEMS.values());
		addItem(ss, FundModel.OT.RBAP.ITEMS.values());
