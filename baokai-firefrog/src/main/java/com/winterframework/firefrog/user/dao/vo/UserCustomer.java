...
public class UserCustomer extends BaseEntity {
	...
	public static final String ALIAS_MODIFY_PASSWD_DATE = "修改密碼時間";
	...
	public static final Long IP_LIMIT = 102009L;// IP限制
	public static final Long IP_LIMIT_REGISTER = 102109L;// IP限制
	public static final Long IP_WHITE_LIST_LIMIT = 102209L;// 指定IP白名單限制
	public static final Long GROUP_LIMIT = 102010L;// 权限组被禁用
	...
	private Long award_ret_status;
	private Integer awardRetStatus;
	private Integer superPairStatus;
	...
	public Date getModifyPasswdDate() {
		return modifyPasswdDate;
	}

	public void setModifyPasswdDate(Date modifyPasswdDate) {
