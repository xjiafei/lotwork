...
import com.winterframework.firefrog.json.api.web.controller.JsonStruc;
import com.winterframework.modules.web.util.JsonMapper;
public class FirefrogHttpMessageConverter extends MappingJackson2HttpMessageConverter {

	private static final Logger log = LoggerFactory.getLogger(FirefrogHttpMessageConverter.class);
	...
	protected void writeInternal(Object object, HttpOutputMessage outputMessage) throws IOException,
		...
		try {
			...
			if (object instanceof JsonStruc && ((JsonStruc) object).getCallBack() != null) {
				String jsonPadding = "callback";
				// If the callback doesn't provide, use the default callback
				String jsonCallback = ((JsonStruc) object).getCallBack();
			...
			//			log.info(jmapper.toJson(object));	
				this.getObjectMapper().writeValue(jsonGenerator, object);
			}
