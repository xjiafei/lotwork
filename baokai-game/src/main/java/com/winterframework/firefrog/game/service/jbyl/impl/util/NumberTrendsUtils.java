package com.winterframework.firefrog.game.service.jbyl.impl.util;
...
import com.winterframework.firefrog.common.config.entity.BetMethodCode;
...
public class NumberTrendsUtils {
	...
	* @return
	...
	public static int duizi(String recordNumber) {
		return isDuizi(recordNumber) > 0 ? isDuizi(recordNumber) : 0;
	}
	...
	* @Description: 判断对子 
	*/
	private static int isDuizi(String recordNumber) {
		int[] num = str2intArray(recordNumber);
		if (num[0] == num[1]) {
			return BetMethodCode.DUIZI.getBetMethodeCode();
		}
		return 0;
	}
