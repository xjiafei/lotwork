...
public interface IGameBettypeStatusDao extends BaseDao<GameBettypeStatus> {
	...
	* @throws Exception
	...
	GameBettypeStatus getGameBettypeStatusByLottery(Long lotteryId, Integer groupCode, Integer setCode, Integer methodCode)
			throws Exception;
	
	GameBettypeStatus getGameBettypeStatusByLottery(Long lotteryId, Integer groupCode, Integer setCode, Integer methodCode,Integer methodType)
			throws Exception;
	/** 
	* @Title: getStatus 
