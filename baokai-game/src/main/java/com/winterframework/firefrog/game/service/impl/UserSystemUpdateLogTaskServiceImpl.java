...
/** 
* @ClassName UserSystemUpdateLogTaskServiceImpl 
* @Description 用户升级日志 
* @author  hugh
* @date 2014年12月2日 下午3:33:15 
*  
*/
@Service("userSystemUpdateLogTaskServiceImpl")
@Transactional(rollbackFor = Exception.class)
public class UserSystemUpdateLogTaskServiceImpl implements IUserSystemUpdateLogService{
