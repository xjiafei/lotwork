...
public class GameRiskConfigDaoImpl extends BaseIbatis3Dao<GameRiskConfig> implements IGameRiskConfigDao {
	...
	*/
	@Override
	public GameRiskConfig queryGameRiskConfig() throws Exception {
		GameRiskConfig config = this.sqlSessionTemplate.selectOne("selectGameRiskConfig");
		return config;
	}
	...
	*/
	...
	public GameRiskConfig queryGameRiskConfig(Long lotteryId) throws Exception {		
		GameRiskConfig config = this.sqlSessionTemplate.selectOne("selectGameRiskConfigByLottery",lotteryId);
		return config;
	}
