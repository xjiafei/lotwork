...
public interface ISNGenerator {
	...
	* @return
	 */
	public abstract String createBusinessSn(EnumItem item, long userId) throws Exception;
	public abstract String createBusinessSnForNull(EnumItem item, long userId) throws Exception;
	...
	* @return
	 */
	public abstract String createFundSn(EnumItem item, long userId) throws Exception;
