...
public class FundChangeLogDaoImpl extends BaseIbatis3Dao<FundChangeLog> implements IFundChangeLogDao {
	...
	@Override
	public void deleteByExCode(String exCode) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("exCode", exCode);
		sqlSessionTemplate.delete(this.getQueryPath("deleteByExCode"),map);
	}
	
	@Override
	public Long queryCountByExCode(String exCode) {
		Map<String, Object> map = new HashMap<String, Object>();
		map.put("exCode", exCode);
		return sqlSessionTemplate.selectOne(this.getQueryPath("getCountByExCode"), map);
	}
}
