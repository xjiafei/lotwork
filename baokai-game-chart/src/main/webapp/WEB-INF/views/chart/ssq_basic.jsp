...
<body class="table-trend">
	...
	<div class="select-section clearfix">
		...
		<ul class="select-list">
			<li class="current"><a href="ssq_basic">基本走势图</a></li>
	...
	<div class="chart-section" id="J-chart-area">
		<table class="chart-table" id="J-chart-table">
			<thead class="thead">
				<tr class="title-text">
					<th colspan="3" rowspan="3" class="border-bottom border-right">期数</th>
					<th colspan="3" rowspan="3" class="border-right border-bottom">开奖号码</th>
					<th colspan="39" class="border-right">红球区</th>
					<th colspan="20" class="border-right">蓝球区</th>
				</tr>
				<tr class="title-text">
					...
					<th colspan="10" class="border-top border-right border-bottom">一区</th>
					<th colspan="10" class="border-top border-right border-bottom">二区</th>
				</tr>
			...
			<tfoot class="tfoot">
				<tr class="title-text">
					<th colspan="3" rowspan="4" class="border-right border-bottom">期数</th>
					<th colspan="3" rowspan="4" class="border-right border-bottom">开奖号码</th>
				</tr>
				<tr class="title-number">
					<th class="ball-none border-bottom"></th>
					<th class="border-bottom"><i class="ball-noraml">01</i></th>
				...
				<tr class="title-text">
					<th colspan="39" class="border-right border-bottom">红球区</th>
					<th colspan="20" class="border-right border-bottom">蓝球区</th>
				</tr>
			</tfoot>
...
(function($){
	...
	CHART = new phoenix.GameCharts({currentGameType:'${view}', getDataUrl: json_data_url, currentGameMethod: '${groupCode}', expands:{
        ${view}${groupCode}Render:function(data, currentNum){
			...
			// 蓝球区一
			parentDom.appendChild(me.singleLotteryBall(data[5], styleName, true));
			// 蓝球区二
			parentDom.appendChild(me.singleLotteryBall(data[6], styleName, true));
			// parentDom.appendChild(me.singleLotteryBall(data[7], styleName));
			/*//号码分布
		...
		cqsscQiansanRenderStatistics: function(data){
			...
			for(i = 0, len = 49; i < len; i++){
				if( i < 33 ){
					tdstr = ((i+1)%11 == 0) ? '<td class="ball-none border-right border-bottom"></td><td class="ball-none border-bottom"></td>' : '';
				}else{
					tdstr = ((i+1-33)%8 == 0) ? '<td class="ball-none border-right border-bottom"></td><td class="ball-none border-bottom"></td>' : '';
				}				
