...
<body class="table-trend">
	...
	<div class="select-section clearfix">
		...
		<ul class="select-list">
			<li><a href="p5chart">基本走势</a></li>
			<li><a href="p5charth2">P5后二</a></li>
			<li class="current"><a href="p3chart">P3基本</a></li>
			<li><a href="p3chartq2">P3前二</a></li>
			<li><a href="p3charth2">P3后二</a></li>
		</ul>
	</div>
