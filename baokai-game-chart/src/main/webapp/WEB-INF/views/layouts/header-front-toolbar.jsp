...
<script type="text/javascript">
    ...
    var userName = '${sessionScope.info.account}';	
    ...
    var userClassId = "J-top-userinfo";							<%-- user panel class id 使用者選單 --%>
    var msgClassId = "J-msg-panel";								<%-- message panel class id 站內信 --%>
    var frontpageLink="_blank";//首頁 是否需要連結				<%-- home page link 首頁連結 --%>
    var betHistory = gameServer + "/gameUserCenter/queryOrders?time=7";<%-- bet history 投注記錄查詢 --%>      
