...
public class LotteryPlayMethodKeyGenerator implements IKeyGenerator, ILotteryKeyFactor {
	...
	*/
	...
	public LotteryPlayMethodKeyGenerator(Long lotteryType, Integer isGeneral, Integer groupCode, Integer setCode, Integer methodCode,
			String seperator) {
	...
	public LotteryPlayMethodKeyGenerator(Integer isGeneral, Integer groupCode, String seperator) {
		this.isGeneral = isGeneral;
		this.groupCode = groupCode;
		this.seperator = seperator;
	}
	...
	*/
	...
	public String generateKey() {
		...
		if (this.isGeneral != null) {
			keyBuffer.append(this.isGeneral.toString());
			keyBuffer.append(seperator);
		}
	...
	public Object clone() {
		...
		key.setIsGeneral(this.isGeneral);
