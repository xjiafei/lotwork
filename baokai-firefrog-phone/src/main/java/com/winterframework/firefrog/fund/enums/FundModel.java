...
public class FundModel {
	...
	public enum FD implements EnumModel {
		...
		public enum CWXX implements EnumFunction {
			...
			public enum ITEMS implements EnumItem {
				//自动体现
				CWXX(FD.DEFAULT, "CWTF", null, 1, MethodEnum.frozenAmtWithBal), CHECK(FD.DEFAULT, "CWTR", null, 2,
						MethodEnum.None), RECHECK(FD.DEFAULT, "CWTR", null, 3, MethodEnum.None), REJECTED(FD.DEFAULT,
						"CWTR", null, 4, MethodEnum.unFrozenAmtWithBal), SUCCESS(FD.DEFAULT, "CWTS", null, 5,
						MethodEnum.cleanFrozenAmt), PART_REDUCE(FD.DEFAULT, "CWTS", null, 6,
						MethodEnum.cleanFrozenAmt), FAILED(FD.DEFAULT, "CWTR", null, 7, MethodEnum.unFrozenAmtWithBal), PART_REFUND(
						FD.DEFAULT, "CWTR", null, 8, MethodEnum.unFrozenAmtWithBal);
				private ITEMS(EnumModel model, String summaryCode, String tradeCode, Integer status, MethodEnum me) {
					this.model = model;
					////this.tradeCode = tradeCode;
					this.summaryCode = summaryCode;
	...
	public enum GM implements EnumModel {
		...
		public enum RRSX implements EnumFunction {
			...
			public enum ITEMS implements EnumItem {
				...
				RRHA(GM.DEFAULT, "RRHA", null, 2,
						MethodEnum.reduceAmt);
				private ITEMS(EnumModel model, String summaryCode, String tradeCode, Integer status, MethodEnum me) {
					this.model = model;
					////this.tradeCode = tradeCode;
					this.summaryCode = summaryCode;
		...
		public enum CRVC implements EnumFunction {
			...
			public enum ITEMS implements EnumItem {
				...
				CRVC_4(GM.DEFAULT, "CRVC", null, 4, MethodEnum.addAmt),
				CRVC_5(GM.DEFAULT, "CRVC", null, 5, MethodEnum.addAmt),
