...
/**
 * 
* @ClassName: BetNumberGroup10ValidateExecutor 
* @Description: 组选10 注数验证 
* @author Richard
* @date 2013-8-6 上午9:51:46 
*
 */
public class BetNumberGroup10ValidateExecutor extends CompositeValidateExecutor<GameSlip> {
