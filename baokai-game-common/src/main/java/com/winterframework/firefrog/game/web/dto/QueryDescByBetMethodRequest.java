...
* @Description: 按投注方式查询玩法描述请求参数封装DTO 
* @author Denny 
* @date 2013-10-12 上午11:24:46 
*  
*/
public class QueryDescByBetMethodRequest implements Serializable {

	private static final long serialVersionUID = 8727432812616811675L;
