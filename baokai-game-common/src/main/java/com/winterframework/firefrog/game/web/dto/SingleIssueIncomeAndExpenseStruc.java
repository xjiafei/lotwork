...
/** 
* @ClassName: SingleIssueIncomeAndExpenseStruc 
* @Description: 运营盈亏报表基本结构 
* @author Denny 
* @date 2014-2-21 下午3:13:21 
*  
*/
public class SingleIssueIncomeAndExpenseStruc implements Serializable {

	private static final long serialVersionUID = 6765793160442308509L;
