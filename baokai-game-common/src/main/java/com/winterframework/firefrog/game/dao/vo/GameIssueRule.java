...
public class GameIssueRule extends BaseEntity {

	private static final long serialVersionUID = -4179413765610355787L;
	//alias
	public static final String TABLE_ALIAS = "奖期生成规则表";
	...
	public static final String ALIAS_STATUS = "规则状态 1:待审核 2:已删除 3:进行中 4:已过期";
	...
	public GameIssueRule() {
	}

	public GameIssueRule(Long id) {
		this.id = id;
	}
