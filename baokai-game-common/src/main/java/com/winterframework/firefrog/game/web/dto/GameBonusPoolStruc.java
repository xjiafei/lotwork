/**   
* @Title: GameBonusPoolStruc.java 
* @Package com.winterframework.firefrog.game.web.dto 
* @Description: TODO(用一句话描述该文件做什么) 
* @author 你的名字   
* @date 2014-7-29 下午3:53:19 
* @version V1.0   
*/
package com.winterframework.firefrog.game.web.dto;

/** 
* @ClassName: GameBonusPoolStruc 
* @Description: TODO(这里用一句话描述这个类的作用) 
* @author 你的名字 
* @date 2014-7-29 下午3:53:19 
*  
*/
public class GameBonusPoolStruc {
	...
	public void setDistribute1process(Long distribute1process) {
	...
	public void setDistribute2process(Long distribute2process) {
