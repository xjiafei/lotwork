...
public class GameIssueTemplateCheck extends BaseEntity {

	private static final long serialVersionUID = 3100179004314549833L;
	private Long ruleid;
	...
	public GameIssueTemplateCheck() {
	}

	public GameIssueTemplateCheck(Long id) {
		this.id = id;
	}
