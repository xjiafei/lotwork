...
public class GameSeriesConfigCheck extends BaseEntity {
	
	private static final long serialVersionUID = 2803299312651489115L;
	
	//alias
	public static final String TABLE_ALIAS = "彩种配置审核表";
	...
	public static final String ALIAS_STATUS = "审核状态 3:待审核 4:待发布";
	...
	public boolean equals(Object obj) {
		if(obj instanceof GameSeriesConfigCheck == false) return false;
		if(this == obj) return true;
		GameSeriesConfigCheck other = (GameSeriesConfigCheck)obj;
