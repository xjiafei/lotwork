...
class Slmmc2000 extends CI_Controller {
    private $request;
    private $post;
    ...
    public function index()
    {
        ...
        $this->curl->create(HOST_4."/slmmc2000/init");
		...
		//過濾超級2000中文
		$return = str_replace("超级2000_","",$return);
        ...
        */
        ...
        $this->load->view("../../m/slmmc2000/index.html", $data);
    }
...
*/
    ...
    public function bet()
    {
        ...
        $post_content = json_encode($this->post);
        $this->curl->create(HOST_4."/slmmc2000/bet");
        $this->curl->option(CURLOPT_HTTPHEADER , array(
            "content-length: " . strlen($post_content),
            "Content-Type: application/firefrog; charset=utf-8"
            )
