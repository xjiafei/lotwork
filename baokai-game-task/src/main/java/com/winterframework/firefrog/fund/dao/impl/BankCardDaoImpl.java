...
import com.winterframework.firefrog.schedule.dto.BankCardBindHistoryRecordQueryDTO;
import com.winterframework.firefrog.schedule.dto.BankCardBindRecordQueryDTO;
...
public class BankCardDaoImpl extends BaseIbatis3Dao<UserBank> implements IBankCardDao {
	...
	public List<BankCard> getBoundBankCard(long userId,String cardNumber) {
		...
		map.put("bank_number", cardNumber);
	...
	private Page<UserCardBind> getUserCardBindRecords(Map<String, Object> map,
		...
		for (UserCardBindVO userCardBindVO : list) {
			...
			try {
				...
				List<BankCard> bankCards = getBoundBankCard(userCardBindVO.getUserId(),map.get("cardNumber")==null?null:(String)map.get("cardNumber"));
