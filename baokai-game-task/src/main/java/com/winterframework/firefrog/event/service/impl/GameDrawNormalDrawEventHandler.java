...
/** 
* @ClassName: GameDrawNormalDrawEventHandler 
* @Description: 正常开奖事件处理类
* @author 你的名字 
* @date 2014-5-8 下午4:08:44 
*  
*/
@Service("gameDrawNormalDrawEventHandler")
@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class, readOnly = false)
public class GameDrawNormalDrawEventHandler implements IEventHandler {
	@Resource(name = "gameDrawNormalDrawServiceImpl")
	private IGameDrawService gameDrawNormalDrawServiceImpl;
	...
	*/
	...
	public void handleEvent(GameControlEvent event) throws Exception {
		gameDrawNormalDrawServiceImpl.doBusiness(event.getLotteryid(), event.getStartIssueCode());
	}
}
