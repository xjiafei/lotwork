...
*  
*/
@Service("gameDrawContinueDrawEventHandler")
@Transactional(propagation = Propagation.REQUIRED, rollbackFor = Exception.class, readOnly = false)
public class GameDrawContinueDrawEventHandler implements IEventHandler {
	@Resource(name = "gameDrawContinueDrawServiceImpl")
	private IGameDrawService gameDrawContinueDrawServiceImpl;
	...
	*/
	...
	public void handleEvent(GameControlEvent event) throws Exception {
		gameDrawContinueDrawServiceImpl.doBusiness(event.getLotteryid(), event.getStartIssueCode());
	}
}
