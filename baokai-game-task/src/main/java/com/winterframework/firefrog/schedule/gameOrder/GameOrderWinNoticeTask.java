 ...
 * 
 */
public class GameOrderWinNoticeTask {

	private Logger log = LoggerFactory.getLogger(GameOrderWinNoticeTask.class);
	...
	public void execute() throws Exception {
		log.debug("----begin GameOrderWinNoticeTask----:");
		gameOrderService.noticeWinOrder();
		log.debug("----end GameOrderWinNoticeTask----");
	}
