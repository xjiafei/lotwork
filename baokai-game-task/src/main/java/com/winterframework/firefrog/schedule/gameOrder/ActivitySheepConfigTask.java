 ...
 * 
 */
public class ActivitySheepConfigTask {

	private Logger log = LoggerFactory.getLogger(ActivitySheepConfigTask.class);
	...
	public void execute() throws Exception {
		log.error("----begin ActivitySheepHongBaoTask excuteConfig----:");
		ativityServiceImpl.excuteConfig();
		log.error("----end ActivitySheepHongBaoTask excuteConfig----");
	}
