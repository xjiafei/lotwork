...
public class GameTrendFenbuChartGenerate extends BaseGeneralRule implements IGameTrendChartGenerate {
	...
	*/
	...
	public GameTrendJbyl doGenerateChart(GameDrawResult gdr, List<GameTrendJbyl> list) throws Exception {
		...
		String omissionNumberPublish = calcCurValue(gdr, lastValue);
		...
		*/
		List<Integer> omissionValues = NumberTrendsUtils.convertString2List(omissionNumberPublish);
		return getGameJbylTrend(omissionNumberPublish,makeSingleOmissionStruc(omissionValues, this.getNumberRecordList(gdr)), gdr);
	}
	...
	protected String calcCurValue(GameDrawResult gdr, String lastValue) {
		...
		return omissionNumberPublish.substring(0, omissionNumberPublish.length() - 1);
	}
