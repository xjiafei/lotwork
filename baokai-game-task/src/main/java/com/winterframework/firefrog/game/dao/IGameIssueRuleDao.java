...
public interface IGameIssueRuleDao {
	...
	* @return
	*/
	public GameIssueRuleEntity getCommenGameIssueRuleByRuleTypeAndDay(Long lotteryId, Date beginOfDate, Date endOfDate,
			Integer day);

	/** 
	* @Title: getSpecialOrStopGameIssueRuleByRuleTypeAndDay 
	* @Description: 获取某个彩种在某天的特殊规则包括休市     2014-2-20由于休市规则可能是休一部分奖期时间，需求变更，特例与休市分别查询
	* @param lotteryId
	* @param beginOfDate 某天起始之间00:00:00
	* @param endOfDate 某天结束时间23:59:59
	* @param day 周一到周日对应的值
