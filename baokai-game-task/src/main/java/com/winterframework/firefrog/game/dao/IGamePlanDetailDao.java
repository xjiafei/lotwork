...
public interface IGamePlanDetailDao extends BaseDao<GamePlanDetail> {
	...
	* @throws Exception
	...
	int updateGamePlanDetailByPlanIdWithOutSatus(Long planId,Long status) throws Exception;
	int updateGamePlanDetailWithOutStatus(Long planId, Long issueCode, Integer status,String cancelUser ) throws Exception;
	...
	*/
	...
	List<GamePlanDetail> getFollowIssueGamePlanDetailWithOutCancel(Long planId, Long issueCode) throws Exception ;
	GamePlanDetail getLastIssueGamePlanDetailWithoutCancel(Long planId, Long issueCode) throws Exception ;
	
	int updateFollowIssueGamePlanDetailWithOutCancelToCancel(Long planId, Long issueCode) throws Exception ;
	...
	/**
	 * 获取追号明细（根据planId和issueCode）
	 * @param planId
	 * @param issueCode
	 * @return
	 * @throws Exception
	 */
	GamePlanDetail getGamePlanDetailByPlanIdAndIssueCode(Long planId,Long issueCode) throws Exception;
