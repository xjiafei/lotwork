 ...
 */
package com.winterframework.combinatorics.permutations;
...
import com.winterframework.combinatorics.util.Util;
...
public class PermutationGenerator<T> extends Generator<T> {
	 ...
	 * 
	 * @see com.winterframework.combinatorics.Generator#getOriginalVector()
	 */
	 ...
	 * 
	 * @see com.winterframework.combinatorics.Generator#getNumberOfGeneratedObjects()
	 */
	public long getNumberOfGeneratedObjects() {
		...
		return Util.factorial(_originalVector.getSize()).longValue();
	}

	/**
	 * Creates an iterator
	 * 
	 * @see com.winterframework.combinatorics.Generator#iterator()
	 */
	@Override
