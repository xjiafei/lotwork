...
public class QQWry {
	...
	public void seek(String ip) throws Exception {
		this.IPN = ipToInt(ip);
		fis = new RandomAccessFile(new File(this.getClass().getClassLoader().getResource(DbPath).getFile()), "r");
		buff = new byte[4];
		fis.seek(0);
		fis.read(buff);
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println(toGBK(w.getCountry()) + " " + w.getLocal());
	}

	private static String toGBK(String str) throws Exception {
