...
class UploadHandler
{
    ...
    protected $error_messages = array(
        ...
        'max_number_of_files' => '已经超过最大上传文件数目',
	...
	public $files_data ;
    function __construct($options = null,$delAction=null,$max_number_files=null, $initialize = true, $error_messages = null) {
        $this->options = array(
            'script_url' => $this->get_full_url().$delAction,
            ...
            'max_number_of_files' => $max_number_files,
    ...
    public function post($print_response = true) {
        ...
        $name = $_FILES[$this->options['param_name']]['name'] ;
		$newNames = explode(".",$name[0]) ;
		$newNames[0] = Md5(time());
		$_FILES[$this->options['param_name']]['name'][0] = $newNames[0].'.'.$newNames[1];
