...
class Message extends Client {
	...
	public function queryUnReadMessageList($jdata = null){
		...
		$uri = Zend_Registry::get ( "firefog" )->message->queryUnReadMessageList;
	...
	public function queryMessageDetail($jdata = null) {
		...
		$uri = Zend_Registry::get ( "firefog" )->message->queryMessageDetail;
		return $this->inRequest ( array_merge ( $this->_data, $jdata ), $uri );
	}
	public function replyMessage($jdata = null) {
		$uri = Zend_Registry::get ( "firefog" )->message->replyMessage;
		return $this->inRequest ( array_merge ( $this->_data, $jdata ), $uri );
	}
	public function deleteMessages($jdata = null) {
		
		$uri = Zend_Registry::get ( "firefog" )->message->deleteMessages;
		return $this->inRequest ( array_merge ( $this->_data, $jdata ), $uri );
	}
	public function sendMessage($jdata = null) {
		$uri = Zend_Registry::get ( "firefog" )->message->sendMessage;
		return $this->inRequest ( array_merge ( $this->_data, $jdata ), $uri );
	}
	public function markRead($jdata = null) {
		$uri = Zend_Registry::get ( "firefog" )->message->markRead;
		return $this->inRequest ( array_merge ( $this->_data, $jdata ), $uri );
	}
	public function saveSub($jdata = null) {
		$uri = Zend_Registry::get ( "firefog" )->message->default;
		return $this->inRequest ( array_merge ( $this->_data, $jdata ), $uri );
	}
	...
	public function messages($jdata = null) {
		...
		$uri = Zend_Registry::get ( "firefog" )->message->querymessagelist;
		return $this->inRequest ( array_merge ( $this->_data, $jdata ), $uri );
	}
