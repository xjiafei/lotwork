...
class Default_ActivityController extends CustomControllerAction{
   ...
   //20172月開春活動 開春簽到送禮領獎
	...
	public function activity201704surveyAction(){
		...
		$this->view->display('default/ucenter/activity/2017/April/activitySurvey.tpl');
	}
	//2017四月問卷調查，檢查用戶充值總額
	...
	public function activity20170404initAction(){			
		...
		$this->view->signStatus = $signStatus;
		$this->view->account = $account;
		$this->view->display('default/ucenter/activity/2017/April/activity04.tpl');
    }
	...
	public function activity20170501initAction(){			
		...
		$this->view->account = $account;
		$this->view->display('default/ucenter/activity/2017/May/activity01.tpl');
   }
	...
	public function activity20170503initAction(){	
		...
		$this->view->account = $account;
		$this->view->awardStatus = $awardStatus;
		$this->view->display('default/ucenter/activity/2017/May/activity03.tpl');
    }
	...
	public function activity20170601initAction(){	
		...
		$this->view->account = $account;
		$this->view->awardStatus = $awardStatus;
		$this->view->display('default/ucenter/activity/2017/June/activity01.tpl');
    }
	...
	public function activity20170603initAction(){	
		...
		$this->view->awardStatus = $awardStatus;
		$this->view->bet = $bet;
		$this->view->display('default/ucenter/activity/2017/June/activity03.tpl');
    }
	...
	public function activity20170701initAction(){	
		...
		$this->view->display('default/ucenter/activity/2017/July/activity01.tpl');
    }
	...
	//2017七月第一週 浮層初始化
	public function activity20170701surveyenterAction(){
		$account = $this->_sessionlogin->info['account'];
		$data['param']['account'] = $account;
		$aUri['activity'] = 'activity20170701surveyEnter';
		$res = $this->_clientObject->inRequestV2($data, $aUri);
		echo json_encode($res['body']['result']);
	}
}
