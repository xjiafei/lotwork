	...
	<div class="col-content">
			...
			<!-- /////////////头部公共页面/////////////// -->
		<div class="col-main">
			<div class="col-crumbs"><div class="crumbs"><strong>当前位置：</strong><a href="#">资金</a> &gt; <a href="#">客户提现</a> &gt; 处理成功</div></div>
			<div class="col-content">
				<div class="col-main">
					<div class="main">
						<div class="ui-tab">
							<div class="ui-tab-title clearfix">
								<ul>
									...
									<li class="current"><a href="/admin/Rechargemange/customersdraw?swithval=4">处理成功</a></li>
				...
				if(data.text){
					...
					$.each(re, function (i) {	
						if(re[i].status=="3"){
							...
							{
								case "1":
									html += "<td><span id='stu_"+i+"'>提现成功</span></td>";		
									html += "<td >" + re[i].applyTime + "</td>";						
									html += "<td ></td>";
									break;											
								default:
