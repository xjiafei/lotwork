	...
	<div class="col-content">
			...
			<!-- /////////////头部公共页面/////////////// -->
		<div class="col-main">
			<div class="col-crumbs"><div class="crumbs"><strong>当前位置：</strong><a href="#">资金</a> &gt; <a href="#">客户提现</a> &gt; 审核未过</div></div>
			<div class="col-content">
				<div class="col-main">
					<div class="main">
						<div class="ui-tab">
							<div class="ui-tab-title clearfix">
								<ul>
									...
									<li class="current"><a href="/admin/Rechargemange/customersdraw?swithval=3">审核未过</a></li>
...
(function() {
	...
	var mask = phoenix.Mask.getInstance(),objString;	
	SelectByWhereInfo("0");	
	//提交数据
				...
				if(data.text){
					...
					$.each(re, function (i) {	
						if(re[i].status=="2"){
							...
							{
								case "1":
									html += "<td><span id='stu_"+i+"' style='color:red'>审核未过</span></td>";								
									html += "<td ></td>";
									break;											
								default:
									html += "<td><span id='stu_"+i+"' style='color:red'>审核未过</span></td>";						
