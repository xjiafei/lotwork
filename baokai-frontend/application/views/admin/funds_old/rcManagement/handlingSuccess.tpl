...
<!-- /////////////头部公共页面/////////////// -->
	<div class="col-main">
			<div class="col-crumbs"><div class="crumbs"><strong>当前位置：</strong><a href="#">资金</a> &gt; <a href="#">异常充值</a> &gt;  <a href="#">异常充值</a> &gt;处理成功</div></div>
			<div class="col-content">
				<div class="col-main">
					<div class="main">
						<div class="ui-tab">
							<div class="ui-tab-title clearfix">
								<ul>
									...
									<li class="current"><a href="/admin/Rechargemange/exceptrecharge?swithval=4">处理成功</a></li>
...
(function() {
	...
	function SelectByWhereInfo(pages) {
		...
		var perPageNum  = new phoenix.SuperSearch({
		 ...
		 $.ajax({
			url:'/admin/Rechargemange/exceptrechagedl?swithval=4',
			dataType:'json',
			method:'post',
			data:formData,
			beforeSend:function(){
			...
			success:function(data){
				...
				if(data.text){
					...
					//数据填充
					$.each(re, function (i) {	
						if(re[i].status=="1" || re[i].status=="2" || re[i].status=="3"){
							...
							html += "<td class='table-tool'><span title='"+re[i].memo+"' pro_span='span_"+i+"'>" + objString + "</span></td></tr>";	
						}					
