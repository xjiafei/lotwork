...
<!-- /////////////头部公共页面/////////////// -->
	<div class="col-main">
			<div class="col-crumbs"><div class="crumbs"><strong>当前位置：</strong><a href="#">资金</a> &gt; <a href="#">异常充值</a> &gt;  <a href="#">异常充值</a> &gt;审核未过</div></div>
			<div class="col-content">
				<div class="col-main">
					<div class="main">
						<div class="ui-tab">
							<div class="ui-tab-title clearfix">
								<ul>
									...
									<li class="current"><a href="/admin/Rechargemange/exceptrecharge?swithval=3">审核未过</a></li>
...
(function() {
	...
	function SelectByWhereInfo(pages) {
		...
		var formData = group.getFormData(),mask = phoenix.Mask.getInstance();
		 ...
		 $.ajax({
			url:'/admin/Rechargemange/exceptrechagedl?swithval=3',
			dataType:'json',
			method:'post',
			data:formData,
			beforeSend:function(){
			...
			success:function(data){
				...
				if(data.text){
					...
					//数据填充
					$.each(re, function (i) {	
						if(re[i].status=="5" || re[i].status=="10"){
