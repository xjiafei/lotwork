...
<!-- /////////////头部公共页面/////////////// -->
	<div class="col-content">
			...
			<!-- /////////////头部公共页面/////////////// -->
		<div class="col-main">
			<div class="col-crumbs"><div class="crumbs"><strong>当前位置：</strong><a href="#">资金</a> &gt; <a href="#">充值管理</a> &gt; <a href="#">资金设置</a> &gt;  <a href="#">银行管理</a> &gt;新增银行信息</div></div>
			<div class="col-content">
				<div class="col-main">
					<div class="main">
						<div class="ui-tab">
							...
							<div >
								<table class="table table-info table-border">
									<thead>
										<tr>
											<th colspan="2" class="text-left">新增</th>
										</tr>
									</thead>
									<tbody>
										<tr>
										...
										<tr>
											<td colspan="2" class="text-left">注：添加成功后，默认为禁用状态</td>
										</tr>
									</tbody>
								</table>
							</div>
