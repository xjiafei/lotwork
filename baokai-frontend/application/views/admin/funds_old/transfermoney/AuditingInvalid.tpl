...
<!-- /////////////头部公共页面/////////////// -->
		<div class="col-main">
			<div class="col-crumbs"><div class="crumbs"><strong>当前位置：</strong><a href="#">资金</a> &gt; <a href="#">人工资金管理</a> &gt; <a href="#">现金打款</a> &gt; 审核未过</div></div>
			<div class="col-content">
				<div class="col-main">
					<div class="main">
						<div class="ui-tab">
							<div class="ui-tab-title clearfix">
								<ul>
									...
									<li class="current"><a href="/admin/Fundsmanage/currenttransfer?swithval=3">审核未过</a></li>
					...
					if(data.text){
						...
						$.each(re, function (i) {		
							if(re[i].status=="1"){
								...
								{
									case "1":
										html += "<td><span id='stu_"+i+"' class='color-red'>审核未过</span></td>";									
										html += "<td>/</td>";
										html += "<td class='sele_"+i+"'></td>";
										html += "<td ></td></tr>";	
										break;														
									default:
										html += "<td></td>";									
