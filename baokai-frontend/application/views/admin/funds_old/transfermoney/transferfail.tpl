...
<!-- /////////////头部公共页面/////////////// -->
		<div class="col-main">
			<div class="col-crumbs"><div class="crumbs"><strong>当前位置：</strong><a href="#">资金</a> &gt; <a href="#">人工资金管理</a> &gt; <a href="#">现金打款</a> &gt;  打款失败</div></div>
			<div class="col-content">
				<div class="col-main">
					<div class="main">
						<div class="ui-tab">
							<div class="ui-tab-title clearfix">
								<ul>
									...
									<li class="current"><a href="/admin/Fundsmanage/currenttransfer?swithval=5">打款失败</a></li>
			 ...
			 $.ajax({
				...
				success:function(data){
					...
					if(data.text){
						...
						//数据填充
						$.each(re, function (i) {	
							if(re[i].status=="4"){//0:等待审核，1：审核未过，2：等待付款，3：付款成功，4：打款失败
								...
								{
									case "4":
										html += "<td><span class='color-red'>打款失败</span></td>";
