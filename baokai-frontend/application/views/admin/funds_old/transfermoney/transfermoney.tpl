...
<!-- /////////////头部公共页面/////////////// -->
		<div class="col-main">
			<div class="col-crumbs"><div class="crumbs"><strong>当前位置：</strong><a href="#">资金</a> &gt; <a href="#">人工资金管理</a> &gt; <a href="#">现金打款</a> &gt;  现金打款</div></div>
			<div class="col-content">
				<div class="col-main">
					<div class="main">
						<div class="ui-tab">
							<div class="ui-tab-title clearfix">
								<ul>
									<li class="current"><a href="/admin/Fundsmanage/currenttransfer?swithval=1">现金打款</a></li>
						...
						$.each(re, function (i) {						
							...
							switch(re[i].status)//0:等待审核，1：审核未过，2：等待付款，3：付款成功，4：付款失败
							{
								case "0":
									...
									break;	
								case "1":
									html += "<td><span class='color-red'>审核未过</span></td>";
									html += "<td>/</td>";
									html += "<td></td>";
									html += "<td>/</td>";
									html += "<td>/</td>";
								...
								case "2":
									...
									break;	
								case "3":
									html += "<td><span class='color-green'>提现成功</span></td>";
									...
									break;	
								case "4":
									html += "<td><span  class='color-red'>付款失败</span></td>";
									html += "<td>/</td>";
									html += "<td></td>";
									html += "<td>/</td>";
									html += "<td>/</td>";
