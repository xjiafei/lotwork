					...
					<div class="ui-tab">
						<div class="ui-tab-title clearfix">
							<ul>
								...
								<li><a href="/admin/user/userlhcpoint?id={$userid}&userLvl={$userLvl}&account={$account}&viplevel={$viplevel}&path_img={$path_img}">六合彩</a></li>
								<!-- {/if} -->
							</ul>
						</div>
						{if $status == "1"}
						...
						<div style="padding:30px;">
							...
							<div id="read_block">
								...
								<!-- {if "USER_MANAGE_LIST_CHANGEPRIZEMODE"|in_array:$smarty.session.datas.info.acls} -->
								<!--
