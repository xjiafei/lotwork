{include file='/admin/header.tpl'}
	<div class="col-content">
		...
		<div class="col-main">
			<div class="col-crumbs"><div class="crumbs"><strong>当前位置：</strong><a href="/admin/Rechargemange/">资金中心</a> &gt; <a href="#">充值管理</a> &gt; 充值明细</div></div>
			<div class="col-content">
				<div class="col-main">
					<div class="main">
											...
											<ul class="sp-filter-cont">
												...
												<li>
													<div class="input-append">
														<input id="J-input-serial" type="text" class="input w-2" size="10" maxlength="30"><a href="javascript:void(0);" class="btn sp-filter-submit"></a>
													</div>
												</li>
											</ul>
