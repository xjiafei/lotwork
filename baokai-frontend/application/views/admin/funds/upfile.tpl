...
<noscript><link rel="stylesheet" href="http://blueimp.github.io/jQuery-File-Upload/css/jquery.fileupload-ui-noscript.css"></noscript>
</head>
<body>
<!--
...
<div class="container">
    ...
    <form id="fileupload" action="/admin/Rechargemange/uploading" method="POST" enctype="multipart/form-data">
        <!-- Redirect browsers with JavaScript disabled to the origin page -->
        <noscript><input type="hidden" name="redirect" value="/admin/Rechargemange/uploading"></noscript>
...
<!-- The main application script 改这里这个 --> 
<script src="{$path_js}/js/main.js"></script>

<!-- The XDomainRequest Transport is included for cross-domain file deletion for IE 8 and IE 9 -->
<!--[if (gte IE 8)&(lt IE 10)]>
<script src="http://blueimp.github.io/jQuery-File-Upload/js/cors/jquery.xdr-transport.js"></script>
<![endif]-->
</body> 
</html>
