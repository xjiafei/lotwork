            ...
            (function () {
                ...
                function unpassed() {
                    ...
                    function SelectByWhereInfo4(pages) {
                        ...
                        $("#Pagination4").hide();
                        $.ajax({
                            url: '/admin/Rechargemange/index?parma=aprl&status=3',
                            dataType: 'json',
                            method: 'post',
                            data: formData4,
                            beforeSend: function () {
                                ...
                                if (data.text.length > 0) {
                                    ...
                                    $.each(re, function (i) {
                                        ...
                                        html += "<td>" + re[i].status + "</td>";
                                         html += "<td><a class='btn btn-small' href='/admin/Rechargemange/index?parma=review&type=aprlunpassed&appealSn=" + re[i].appealSn + "' style='position:initial' ><font color='#25a38a'>查 看</font><b class='btn-inner'></b></a>&nbsp;</td>";
