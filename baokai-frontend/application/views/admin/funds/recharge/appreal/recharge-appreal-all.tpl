                ...
                <div class="main">
                    <div  class="ui-tab">	
                        ...
                        <ul class="ui-form ui-tab-content"  name="DivRules">
                            <li>
                                <!-- {if "FUND_APPEAL_ALL_DOWNLOAD"|in_array:$smarty.session.datas.info.acls} -->
                                    <h3 class="ui-title"><a class="btn btn-small " id="downloadReport" style="float:left;display:none;">下载报表<b class="btn-inner"></b></a></h3>
                                <!-- {/if} -->
                                        ...
                                        <tr>
                                            ...
                                            <th  id="J-sp-userlvl" class="sp-td">
                                                <div class="sp-td-cont sp-td-cont-b">
                                                    ...
                                                    <div class="sp-filter-cont sp-filter-cont-b sp-filter-cont-select" style="">
                                                        <ul>
                                                            <li data-select-id="-1"><a href="#">全部</a></li>
                                            ...
                                            <th id="J-sp-Status" class="sp-td">
                                                <div class="sp-td-cont sp-td-cont-b">
                                                    ...
                                                    <div class="sp-filter-cont sp-filter-cont-b sp-filter-cont-select" style="">
                                                        <ul>
                                                            <!-- {foreach from=$appStatus key=key item=data} -->
            ...
            (function () {
                ...
                function AllData() {
                    ...
                    function SelectByWhereInfo(pages) {
                        ...
                        $("#Pagination").hide()
                        $.ajax({
                            url: '/admin/Rechargemange/index?parma=aprl',
                            dataType: 'json',
                            method: 'post',
                            data: formData,
                            beforeSend: function () {
                                ...
                                if (data.text.length > 0) {
                                    ...
                                    $.each(re, function (i) {
                                       ...
                                       if (re[i].vipLvl != ''){
                                        ...
                                        html += "<td>充值申诉</td>";
                                        html += "<td><a class='btn btn-small' href='/admin/Rechargemange/index?parma=review&type=aprlall&appealSn=" + re[i].appealSn + "' style='position:initial' ><font color='#25a38a'>查 看</font><b class='btn-inner'></b></a>&nbsp;</td>";
                                        html += "<td>" + re[i].reviewer + "</td>";
                                        html += "<td>" + re[i].reviewStartTime + "</td>";
                                        html += "<td>" + re[i].reviewEndTime + "</td>";
                                        html += "<td>" + re[i].reviewMemo + "</td>";
                                    });
                ...
                $('#downloadReport').click(function () {
                    ...
                    window.open("/admin/Rechargemange/index?parma=exdwl" + param);
                });
            })();
        </script>
    {/literal}
