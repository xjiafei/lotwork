	<form action="/admin/Rechargemange/index?parma=sv2&step=0&type=6"
		method="post" id="J-form1" name="J-form1">
		<table class="table table-info table-border">
			<thead>
				<tr>
					<th colspan="2" class="text-left">微信支付充值配置</th>
				</tr>
			</thead>
			<tbody>
				<tr>
					...
					<td class="text-left">
						<dl class="set-list">
							...
							<dt></dt>
							<dd>
								<span class="ui-info">单日限额：</span> 
									<input type="text" name="{$v1['id']}@daylimit" value="{$v1['daylimit']}"class="input w-1"/> 
				...
				<tr>
					...
					<td class="text-left"><span class="ui-info">显示倒计时分钟数：</span> <input
						type="text" name="charge_ratio" value="{$cdata6}"
						class="input w-1"> <span class="ui-info">分钟</span></td>
				</tr>
