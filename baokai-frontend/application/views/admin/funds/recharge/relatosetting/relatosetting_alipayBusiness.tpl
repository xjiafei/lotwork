<form action="/admin/Rechargemange/index?parma=sv2&step=0&type=5"
		...
		<tbody>
			<tr>
				...
				<td class="text-left">
					<dl class="set-list">
						...
						<input type="hidden" name="{$v1['id']}@version" value="0.0001">
						<!-- {/if} -->
						<!-- {/if} -->
						<!-- {/foreach} -->
					</dl>
			...
			<tr>
				...
				<td class="text-left"><span class="ui-info">显示倒计时分钟数：</span> <input
					type="text" name="charge_ratio" value="{$cdata5}" class="input w-1">
