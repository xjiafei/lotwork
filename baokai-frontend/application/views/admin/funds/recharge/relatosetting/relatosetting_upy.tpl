<form action="/admin/Rechargemange/index?parma=sv2&step=0&type=3"
	method="post" id="J-form1" name="J-form1">
	<table class="table table-info table-border">
		<thead>
			<tr>
				<th colspan="2" class="text-left">银联充值配置</th>
			</tr>
		</thead>
		<tbody>
			<tr>
			...
			<tr>
				...
				<td class="text-left"><span class="ui-info">显示倒计时分钟数：</span> <input
					type="text" name="charge_ratio" value="{$cdata3}" class="input w-1">
