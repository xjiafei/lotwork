					...
					<div class="step">
						<table class="step-table">
							<tbody>
								<tr>
									...
									<td {if $stp eq 2}class="current"{/if}><div class="tri"><div class="con">3.银联在线支付汇款</div></div></td>
								</tr>
							</tbody>
						</table>
					</div>
						<ul class="ui-form bank-select-from">
							...
							<!-- <li >
								...
								<input type="password" class="input w-4" value="" id="password" name="password"  autocomplete="off" > 
								<span class="ui-check" id="checkpassword"></span>
							</li> -->
							<li class="ui-btn"><a href="javascript:void(0);" id="J-next-step" class="btn btn-important">下一步<b class="btn-inner"></b></a><span id="wait_msg" style="display:none;color:red;position:relative;top:10px;">　请稍等，正在获取信息……</span></li>
						</ul>
...
<div>
	...
	<div>
		<table width="100%" border="0" cellspacing="10" cellpadding="0">
		  ...
		  <tr>
			<td align="right" class="wd-td-bold">收款人姓名：</td>
			<td style="color:red"><#=rcvAccountName#></td>
		  </tr>
		  <tr>
			<td align="right" class="wd-td-bold">收款财付通帐号：</td>
		  ...
		  <tr>
			<td align="right" class="wd-td-bold">附言(充值订单号)：</td>
...
(function(){
	...
	chargeamount.blur(function(){
	    ...
	    $('#chineseMoney').css("display","inline");
