			...
			<div class="common-article">
				<div class="title">
					<div class="more">
						...
						<a href="/Service2/servicesub?unread={$unread}" class="current">给下级发信</a>
						{/if}
					</div>	
...
(function($){	
	//验证标题与正文
	var TxttitlePar,TxtText,TxtTextPar,
	//表单检测错误数量
		errorTypes = ['TxtText'],
		errorHas = {},
	...
	function OpenFrom()
	{
	  ...
	  $('#subSend').click(function(e){		    
		...
		$.ajax({		
				...
				data:'receiveId='+idds+'&sendAccount='+js+'&content='+$("#TxtText").val().trim()+'&typeid='+1,	
				beforeSend:function(){				
					//禁用发送												
