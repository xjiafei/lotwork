...
<head>
    ...
    <title>英雄筑梦之“销”里藏宝</title>
    <meta name="description" content="宝开彩票">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="{$path_img}/images/activity/2017_June/activity03/pc/images/main.css">
    <script src="{$path_js}/js/activity/2017_June/activity03/jquery-3.2.0.min.js"></script>
    <script src="{$path_js}/js/activity/2017_June/activity03/index.js"></script>
</head>
<body>
<div id="main">
    <div id="main-body">
        ...
        <div id="activity-rules">
            <ol>
                ...
                <li>投注必须为已开奖注单，视为有效投注，奖励计算依据用户在活动期间内的有效投注量审核计算， PT、宝开游艺FHX、六合彩、骰 宝大小单双销量不计算在活动销量内。</li>
                <li>本次活动采取报名制，用户需要点击“我要报名”，达到销量即可自行点击抽奖。注：VIP3（包含VIP3）以上用户无需报名即可参加。</li>
                <li>活动兑换奖金仅限当日有效，活动当日没有兑换奖金，当日奖金将作废，次日00:00:00将清空前一日销量并且重新计算销量。</li>
