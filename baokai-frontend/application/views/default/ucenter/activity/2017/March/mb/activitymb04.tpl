...
<link rel="stylesheet" href="{$path_img}/images/activity/2017_March/activity04/mobile/style_mobile.css">
<script src="{$path_js}/js/activity/2017_March/activity01/mb/flexible.min.js"></script>
...
<div class="main">
    <input type="hidden" id="token" value="{$token}"/>
		<div class="banner">
			<div class="btn_box">
                                                                            <!-- {if $signStatus == -22} -->
				<a id="join" class="btn btn_join" href="#" >立即报名</a>
                                                                            <!--{else if $signStatus == -23 || $signStatus == -20} -->
                                                                              <a class="btn btn_finish"  href="phlotto://go_lottolobby">已报名</a>
                                                                            <!--{else} -->
		...
		<div class="footer">
			活动期间禁止任何刷量作弊行为，一经发现宝开彩票平台将取消参与活动资格，<br>严重者将被冻结账号处理。宝开平台保留活动最终解释权。<br>
			©2003-2017 宝开彩票 All Rights Reserved
		</div>
</div>
</body>
<script src="{$path_js}/js/jquery-1.9.1.min.js"></script>
<script src="{$path_js}/js/activity/2017_March/activity04/mb/index.js"></script>
<script>
