...
<link rel="stylesheet" href="{$path_img}/images/activity/2017_May/activity03/mb/images/style.css">
...
<div class="allbg">
		<div class="banner">
            <a class="logo" href="phlotto://go_lottolobby">宝开彩票</a>
			<div class="btn">
				<a id="before" class="btn-before" href="#"></a>
                <a id="joined" class="btn-joined" href="#"></a>
				<a id="done" class="btn-done" href="phlotto://go_lottolobby"></a>
		...
		<div class="rule">
			<div class="part1">
				...
				<p>活动期间（共六天）充值累计达到以下要求，并在活动时间内有效投注大于等于累计充值金额的6倍即可领取相对应比例的奖金</p>
				<h3>普通玩家奖励</h3>
				<table>
					<tr>
						<th>活动期间累计<br>充值金额</th>
						<th>≥500</th>
						<th>≥5,000</th>
						<th>≥50,000</th>
						<th>≥150,000</th>
...
<script src="{$path_js}/js/activity/2017_May/activity03/mb/index.js"></script>    
