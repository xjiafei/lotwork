...
<head>
  ...
  <link rel="stylesheet" href="{$path_img}/images/activity/2016_DecRedBow/activityGroup/css/index.mobile.css">
</head>
...
<body onload="querySignUp();queryJanSignUp();">
  ...
  <div class="header">
    <img src="{$path_img}/images/activity/2016_DecRedBow/activityGroup/imgs/mobile/header_bg.jpg" alt="" class="img-bg">
    <div class="cutdown">
      <div class="timer">
        <span>抽奖倒计时</span>
        <span class="timesamp" id="timesamp">60:00</span>
      </div>
      ...
      <!-- <p class="tips J_tips"> 还没摇到你，继续努力哦~ </p> -->
      <p class="tips J_tips text-win"> 你已经中奖，请联系客服~ </p>
    </div>
    ...
    <div class="btns">
      ...
      <!-- <button class="btn btn-joined" type="button">已报名</button> -->

      <a class="btn btn-viewDetail" href="javascript:;" onclick="redirectDetailPage();">了解详情</a>
    </div>
  ...
  <div class="rules">
    ...
    <div class="rules-header">
      <ul class="tab-list">
        ...
        <li class="item cur J_rules_tab" id="secondTab">官彩狂欢周</li>
      </ul>
    </div>

    <div class="rules-app J_rules_con" style="display: none;">
    ...
    <div class="rules-lottery J_rules_con"  style="display: block;">
  ...
  <script type="text/javascript">
    ...
    (function(doc, win) {
      var docEl = doc.documentElement,
        ...
        recalc = function() {
          ...
          htmlFontSize = 100 * (clientWidth / 720);
    ...
    if (oJoin12) {
      oJoin12.addEventListener('click', function() {
        ga('send', 'event', '手機聚合頁-12月第四周活动报名', '点击【立即报名】按钮');
      }, false);
    }
    if (oJoin1) {
      oJoin1.addEventListener('click', function() {
        ga('send', 'event', '手機聚合頁-1月活动报名', '点击【立即报名】按钮');
      }, false);
    }

  </script>
  <script src="{$path_js}/js/activity/2016_DecRedBow/group/js/index.mobile.js"></script>
  <script src="{$path_js}/js/activity/2016_DecRedBow/group/js/signUp.mobile.js"></script>
