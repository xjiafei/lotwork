...
<head>
    ...
    <link rel="stylesheet" href="{$path_img}/images/activity/2017_FebOpenSpring/css/index-mobile.css">
     <script src="{$path_js}/js/activity/2017_FebOpenSpring/mb/flexible.min.js"></script>
</head>
...
<body onload="query20170202SignUp();query20170203SignUp();">
    ...
    <div class="contain">
      ...
      <div class="reward1">
        ...
        <div class="swiper-container">
          <div class="swiper-wrapper calendar clearfix J_calendar">
      ...
      <div class="reward2 clearfix">
        ...
        <ul class="match-list">
          <li class="item ">连续 3 天 - 获取 16 元红包 <br><small>两次连续3天，可领取2次</small></li>
    ...
    <div class="contain">
      ...
      <div class="rules">
        ...
        <div class="notice">
          ...
          <p>例：用户A当日累计充值1,000元，当日销量为15,000，<br>打够了15倍流水，奖金为1,000*25%=250元。<br>VIP用户奖金为1,000*30%=300元</p>
        </div>
      </div>
    </div>
  </div>
  ...
  <script src="{$path_js}/js/activity/2017_FebOpenSpring/mb/index-mobile.js"></script>
  <script src="{$path_js}/js/activity/2017_FebOpenSpring/mb/signUp.js"></script>
