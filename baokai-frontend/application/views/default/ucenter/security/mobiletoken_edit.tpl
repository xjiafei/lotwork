				...
				<div class="content">
					...
					<ul class="ui-form">
						...
						<li class="address" id="J-panel-serial">
							<label for="name" class="ui-label">新的宝开安全中心序列号：</label>
						...
						<li class="ui-btn">
							<a href="#" id="J-button-submit" class="btn btn-important">修改绑定<b class="btn-inner"></b></a>
							&nbsp;&nbsp;&nbsp;&nbsp;
...
(function($){
	...
	$('#J-button-submit').click(function(e){
		e.preventDefault();
		if(checkSafePassword() && checkCode() && checkserialls() && checkMobileType()){
			...
			$.ajax({
				url:'/safepersonal/modifymobiletoken/',
				dataType:'json',
				cache:false,
				method:'POST',
				data:{password:Base64.encode(passowrdv), code:codev, serials:seriallv, type:type},
				...
				success:function(data){
					if(Number(data['isSuccess']) == 1){
						...
						minWindow.setContent('<div class="pop-title"><i class="ico-success"></i><h4 class="pop-text">修改成功！</h4><div style="text-align:center;padding:10px;"><span id="J-jump-time">3</span>秒后返回安全中心</div></div><div class="pop-btn"><a class="btn btn-important" href="/safepersonal/">返回安全中心<b class="btn-inner"></b></a></div>');
						minWindow.show();
