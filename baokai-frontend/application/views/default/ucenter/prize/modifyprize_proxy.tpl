...
<!-- /////////////头部公共页面/////////////// -->	
												...
												<dd {if $sub_data.betType eq '1'} class="bet-selected" {/if}>
													...
													<!-- {if  $sub_data.lotteryId != '99701'} -->
														<tr>
															...
															<td></td>
															<!-- {/if} -->
															<td rowspan="3"><input type="checkbox" class="checkbox" {if $sub_data.status eq '1'} checked disabled{/if} name="status_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}" value="1"/></td>
														</tr>
													<!-- {/if} -->
														...
														<tr>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_threeLimitRet}-{$sub_data.down_maxThreeOneRet}" disabled name="threeoneRet_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr><td></td>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcFlatcodeLimit}-{$sub_data.down_maxLhcFlatcode}" disabled name="lhcFlatcode_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr><td></td>
															...
															<!-- {if $sub_data.down_directLimitRet eq $sub_data.down_maxDirectRet or $sub_data.down_directLimitRet gt $sub_data.down_maxDirectRet} -->
																...
																<span>(可分配返点范围为{if $sub_data.down_directLimitRet>0}{$sub_data.down_directLimitRet}{else}0{/if}-{if $sub_data.directLimitRet>0}{$sub_data.directLimitRet}{else}0{/if})</span>
															<!-- {else} -->
																<input type="input" class="input w-2" value="{$sub_data.down_directLimitRet}-{$sub_data.down_maxDirectRet}" disabled name="directRet_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr><td></td>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcYearLimit}-{$sub_data.down_maxLhcYear}" disabled name="lhcYear_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr><td></td>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcColorLimit}-{$sub_data.down_maxLhcColor}" disabled name="lhcColor_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr><td></td>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcHalfwaveLimit}-{$sub_data.down_maxLhcHalfwave}" disabled name="lhcHalfwave_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr><td rowspan="3" style="width:140px">{$sub_data.awardName}：</td>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcOneyearLimit}-{$sub_data.down_maxLhcOneyear}" disabled name="lhcOneyear_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcNotinLimit}-{$sub_data.down_maxLhcNotin}" disabled name="lhcNotin_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcContinuein23Limit}-{$sub_data.down_maxLhcContinuein23}" disabled name="lhcContinuein23_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr><td></td>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcContinuein4Limit}-{$sub_data.down_maxLhcContinuein4}" disabled name="lhcContinuein4_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr><td></td>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcContinuein5Limit}-{$sub_data.down_maxLhcContinuein5}" disabled name="lhcContinuein5_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr><td></td>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcContinuenotin23Limit}-{$sub_data.down_maxLhcContinuenotin23}" disabled name="lhcContinuenotin23_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
																<a class="label-like" data-retstatus="2"  data-value="{$sub_data.lhcContinuenotin23Limit*100}" data-wanfadata="1" data-wanfa="{$aRateIndex[$sub_data.lotterySeriesCode][10]}" data-awardgroup="{$sub_data.awardGroupId}" data-lottery="{$sub_data.lotteryId}" data-lotterySeriesCode="{$sub_data.lotterySeriesCode}"  data-modifyprize="1" >点击修改</a>
																</span>
															<!-- {/if} -->
															</td>
														</tr>
														...
														<tr><td></td>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcContinuenotin4Limit}-{$sub_data.down_maxLhcContinuenotin4}" disabled name="lhcContinuenotin4_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr><td></td>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcContinuenotin5Limit}-{$sub_data.down_maxLhcContinuenotin5}" disabled name="lhcContinuenotin5_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr><td></td>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_lhcContinuecodeLimit}-{$sub_data.down_maxLhcContinuecode}" disabled name="lhcContinuecode_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
														...
														<tr>
															<td style="text-align:left;">
															<!-- {if $sub_data.status eq '1'} --> 
																<a class="label-like" style="width:80px;"  data-value="{$sub_data.superLimitRet*100}" data-wanfadata="1" data-wanfa="{$aRateIndex[$sub_data.lotterySeriesCode][2]}" data-awardgroup="{$sub_data.awardGroupId}" data-lottery="{$sub_data.lotteryId}">{$aRateName[$sub_data.lotterySeriesCode][2]}</a>
															<!-- {else} -->
																<span class="label-like" style="width:80px;">{$aRateName[$sub_data.lotterySeriesCode][2]}</span>
															<!-- {/if} -->
															<!-- {if $sub_data.down_superLimitRet eq $sub_data.down_maxSuperRet or $sub_data.down_superLimitRet gt $sub_data.down_maxSuperRet} -->
																<input type="input"  onBlur="CheckingMaxAllFull(this,'{if $sub_data.superLimitRet>=0}{$sub_data.superLimitRet}{else}0{/if}','{if $sub_data.down_superLimitRet>0}{$sub_data.down_superLimitRet}{else}0{/if}')" class="input w-2" {if $sub_data.status eq '1'} minvalue="{if $sub_data.down_superLimitRet>0}{$sub_data.down_superLimitRet}{else}0{/if}"{/if} maxvalue="{if $sub_data.superLimitRet>0}{$sub_data.superLimitRet}{else}0{/if}" value="{$sub_data.down_superLimitRet}" name="superRet_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
															...
															<!-- {else} -->
																<input type="input" class="input w-2"  value="{$sub_data.down_superLimitRet}-{$sub_data.down_maxSuperRet}" disabled name="superRet_{$sub_data.lotterySeriesCode}_{$sub_data.lotteryId}_{$sub_data.awardGroupId}"/>
																<span>
																<a class="label-like" data-retstatus="1"  data-value="{$sub_data.superLimitRet*100}" data-wanfadata="1" data-wanfa="{$aRateIndex[$sub_data.lotterySeriesCode][1]}" data-awardgroup="{$sub_data.awardGroupId}" data-lottery="{$sub_data.lotteryId}" data-lotterySeriesCode="{$sub_data.lotterySeriesCode}"  data-modifyprize="1" >点击修改</a>
																</span>
															<!-- {/if} -->
															</td>
														</tr>
	...
	<div class="pop w-7" style="position:absolute;left:100px;display:none" id="divRegSuccess">
		...
		<div class="bd">
			<h4 class="pop-title">修改成功！</h4>
			<div class="pop-btn">
				<a href="javascript:void(0);" class="btn btn-important " id="searchUrl">确定<b class="btn-inner"></b></a>
			</div>
		</div>
	</div>
...
<script type="text/javascript">
  ...
  (function($){	
	var inputs = $('.table').find('[type="input"]'),addfile,box = new LightBox("divIsEmpty"),box2=new LightBox("divOperatSuccess"),box4=new LightBox("divNoType");	
	if(emptyRewards ==1){
    ...
    $("[name='divOperatSuccess']").bind("click",function(){
		box.Close();
		box2.Close();
		box4.Close();
	});
