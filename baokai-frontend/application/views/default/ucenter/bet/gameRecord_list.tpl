				...
				<div class="content">
					...
					<ul class="ui-search ui-search-more clearfix" id="divDetailed">
						<li class="issues">
							...
							<select class="ui-select" name="lotteryCount">
					...
					<table class="table table-info">
						...
						<tr>
								...
								<td>重庆时时彩</td>
								<td>20121218012</td>
								<td><span class="price"><dfn>&yen;</dfn>3,000.00</span></td>
								<td>等待开奖</td>
								<td>否</td>
								<td>2012-02-28 22:22:00</td>
								<td><a href="/bet/plans">查看</a></td>
							</tr>
							<tr>
								<td>ABC77779</td>
								<td>重庆时时彩</td>
...
<!--							{if $pages}-->
<!--								<div class="page-wrapper"> -->
<!--								{if $pages.min && $pages.currpage.index!=1}-->
<!--									<a href="?cid={$pagevar.cid}&page={$pages.min.index}&order={$pagevar.order}&by={$pagevar.by}">第一页</a>-->
<!--								{/if}-->
...
<!--								  {/if}-->
<!--								{if $pages.max && $pages.currpage.index!=$pages.max.index}-->
<!--									<a href="?cid={$pagevar.cid}&page={$pages.max.index}&order={$pagevar.order}&by={$pagevar.by}">最后页</a>-->
<!--								{/if}-->
<!--								-->
<!--								</div>-->
<!--							{/if}-->
