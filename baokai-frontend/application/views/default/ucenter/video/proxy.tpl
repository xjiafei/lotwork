...
<body>
	...
	<section class="content">
		...
		<div class="video-area">
			...
			<div class="girl"></div>
			<nav>
				<a href="javascript:;" data-video="0" class="video control bingo"><i></i></a>
				<a href="javascript:;" data-video="1" class="video guest"><i></i></a>
				<a href="javascript:;" data-video="2" class="video safe"><i></i></a>
				<a href="javascript:;" data-video="3" class="video bet"><i></i></a>
				<a href="javascript:;" data-video="4" class="video dream"><i></i></a>
				<a href="../index/manual" class="guide"><i></i></a>
				<a href="http://www.ph158.net/daili/" class="proxy"><i></i></a>
			</nav>
		</div>
	</section>
	<footer>
...
<script>
	$(function(){
		var videoDom = $('#J-video-play'),
			videoList = [
				'<embed src="http://player.youku.com/player.php/sid/XODMwOTY4MTg0/v.swf" allowFullScreen="true" quality="high" width="593" height="372" align="middle" allowScriptAccess="always" type="application/x-shockwave-flash"></embed>',
