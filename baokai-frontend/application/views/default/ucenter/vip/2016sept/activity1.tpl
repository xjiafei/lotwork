...
<link href="{$path_img}/images/activity/sept/week1/css/style.css" rel="stylesheet">
...
<div class="allBg">
	...
	<div class="main">
		<h3>活动说明:</h3>
			<p><img src="{$path_img}/images/activity/sept/week1/images/table.jpg"></p>
...
$(function(){
	var sdata = "month=9&source=web&startTime=20160905&endTime=20160910";
	 $.ajax({
 ...
 <script>
  ...
  ga('send', 'pageview');
    ...
    $("#register").on('click',function(){
      ga('send', 'event', '活动1詳情報名', 'click(点击)');
    });
  })
