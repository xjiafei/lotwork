    ...
    <div class="toolbar"> 
		<div class="g_33">
            ...
            <span class="game-menu-text dropdown-menu-btn">彩票</span>
					...
					<div class="game-menu-inner">
						<div class="game-menu-box">
							...
							<div class="game-menu-list">
								...
								<a target="_blank" class="new-game" href="{$game_server}/gameBet/slmmc">秒开时时彩彩<i></i></a>
							</div>
						</div>
						<div class="game-menu-box">
			 ...
			 <a href="{$ptgame_server}/pt/index/" target="_blank" class="back-top-home">老虎机</a>
            <a href="/index/" target="_blank" class="back-top-home">返回首页</a>
			<ul class="menu">
	...
	<div class="header">
		<div class="g_33">
			...
			<div class="service">
				<a class="link-service" href="https://v88.live800.com/live800/chatClient/chatbox.jsp?companyID=740552&configID=2945&jid=4611765122&skillId=145&s=1" />在线客服</a>
                                <div class="service-box"><i class="tri"></i>在线客服打不开？
                                    <a class="support_service_link" a="{$smarty.session.datas.info.account}" aid="{$smarty.session.datas.info.id}" l="{$smarty.session.datas.info.vipLvl}">请点击</a>
						</div>
