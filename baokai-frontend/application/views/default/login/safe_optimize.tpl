		 		...
		 		<form action="#" method="post">
		 			<div id="J-user-info" class="user-info clearfix">
		 				...
		 				<div id="J-password-area" class="hide">
			 				...
			 				<a href="/login/findpwd" class="forget-password">忘记密码？</a>
		 			...
		 			<div class="login-tips">返回使用<a href="/login/index" class="link">普通登录</a></div>
		 		</form>
		 	</div>
...
<script src="{$path_js}/js/login/login-safe.min.js"></script>
<script type="text/javascript">
   (function() {       
	function async_load(){           
