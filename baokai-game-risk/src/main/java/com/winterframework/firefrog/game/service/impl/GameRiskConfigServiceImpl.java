...
public class GameRiskConfigServiceImpl implements IGameRiskConfigService {
	...
	*/
	@Override
	public GameRiskConfig selectGameRiskConfig(Long lotteryId) throws Exception {
		GameRiskConfig config = gameRiskConfigDaoImpl.queryGameRiskConfig( lotteryId);
	...
	*/
	...
	public void updateGameRiskConfig(GameRiskConfig grc) throws Exception {
		GameRiskConfig config = gameRiskConfigDaoImpl.queryGameRiskConfig(grc.getLotteryId());
