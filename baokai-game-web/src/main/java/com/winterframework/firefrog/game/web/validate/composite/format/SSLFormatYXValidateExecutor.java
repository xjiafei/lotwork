...
/** 
* @ClassName: SSLFormatYXValidateExecutor 
* @Description: 时时乐一星投注格式验证
* @author david 
* @date 2013-8-5 下午6:01:22 
*  
*/
public class SSLFormatYXValidateExecutor extends CompositeValidateExecutor<GameSlip> {
	private static Logger log = LoggerFactory.getLogger(SSLFormatYXValidateExecutor.class);
	@Override
