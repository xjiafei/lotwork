...
public class BetHttpJsonClient {
	...
	@PropertyConfig("url.game.queryGameOdds")
	private String queryGameOdds;
	
	@PropertyConfig("url.game.queryGameZodiac")
	private String queryGameZodiac;
	
	@PropertyConfig("url.game.queryGameTips")
	private String queryGameTips;
	
	@PropertyConfig("url.game.getWinningList")
	private String getWinningListUrl;
	
	@PropertyConfig("url.game.getPlayerBetList")
	private String getPlayerBetListUrl;
	
	@PropertyConfig("url.game.saveUserHeadImg")
	private String saveUserHeadImgUrl;
	
	@PropertyConfig("url.game.getPrizeBetList")
	private String getPrizeBetListUrl;
	...
	public Response<GameOrderResponse> saveGameOrder(GameOrderRequest request, Long userId, String account)
			throws Exception {
		return httpClient.invokeHttp(serverPath + saveGameOrder, request, userId, account, GameOrderResponse.class);
	}
	...
	public Response<GameLhcOddsResponse> getGameOdds()
			throws Exception {
		return httpClient.invokeHttp(serverPath + queryGameOdds,"",  GameLhcOddsResponse.class);
	}
	
	public Response<GameLhcZodiacResponse> getGameZodiac()
			throws Exception {
		return httpClient.invokeHttp(serverPath + queryGameZodiac,"",  GameLhcZodiacResponse.class);
	}
	
	public Response<GameLhcTipsResponse> getGameTips()
			throws Exception {
		return httpClient.invokeHttp(serverPath + queryGameTips,"",  GameLhcTipsResponse.class);
	}
	
	public Response<List<Integer>> getPrizeBetLis(Map<String,Long> request, Long userId, String account) throws Exception {
		return httpClient.invokeHttp(serverPath + getPrizeBetListUrl, request, userId, account ,List.class);
	}
	
	public Response<LinkedHashMap> getWinningList(Map<String,String> request, Long userId, String account) throws Exception {
		return httpClient.invokeHttp(serverPath + getWinningListUrl, request, userId, account ,LinkedHashMap.class);
	}
	
	public Response<GameOrderQueryResponse> getPlayerBetList(Map<String,Long> request, Long userId, String account) throws Exception {
		return httpClient.invokeHttp(serverPath + getPlayerBetListUrl, request,userId, account , GameOrderQueryResponse.class);
	}
	
	public Response<Long> saveUserHeadImg(Map<String,String> request, Long userId, String account) throws Exception {
		return httpClient.invokeHttp(serverPath + saveUserHeadImgUrl, request, userId, account ,Long.class);
	}
