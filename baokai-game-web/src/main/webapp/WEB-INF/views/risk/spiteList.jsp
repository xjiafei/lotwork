...
<body>
							...
							<tbody>
								<c:forEach items="${spites}" var="spite">
									<tr>
										...
										<a href="${currentContextPath}/gameoa/queryOrderDetail?orderid=${spite.orderId}&orderCode=${spite.orderCode}" >
										</permission:hasRight>
										${spite.orderCode}
										<permission:hasRight moduleName="GAME_OPMGR_WARNLIST_SPITE_DETAIL">
										</a>
										...
										<td><fmt:formatNumber value="${spite.totamount/10000}" pattern="#,###.##"  minFractionDigits="2"/></td>										
										<td>
										${spite.status }
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/risk/spiteList.js"></script>
</body>