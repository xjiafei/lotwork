...
<body>
						...
						<table class="table table-info" id="J-table">
							...
							<tbody>
								...
								<tr>
									...
									<td><fmt:formatNumber value="${riskOrders.countWins/10000 }" pattern="#,###.##"  minFractionDigits="2"/></td>
									<td>${riskOrders.issueWinsRatio/10000 }</td>
									<td>${riskOrders.orderwarnContinuousWins }</td>
									<td>${riskOrders.continuousWinsTimes }</td>
									<td>
										<a href="${currentContextPath}/gameoa/queryOrderListByIssueCode?lotteryId=${riskOrders.lotteryid}&issueCode=${riskOrders.issueCode}"><spring:message code="gameCenter_fanganjilu" /></a>
										<a href="">交易记录</a>
									</td>
								</tr>
										...
										<table class="table table-border">
											<thead>
												<tr>
													...
													<th>投注时间</th>
													<th><spring:message code="gameCenter_touzhujine" />(&yen;)</th>
													<th><spring:message code="gameCenter_jiangjin" />(&yen;)</th>
													<th>中奖号码</th>
													<th>方案中/投比</th>
													<th>单注最大奖金(&yen;)</th>
													<th>单注最大中/投比</th>
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/operations/warn/warnList.js"></script>
</body>