								...
								<c:choose>
										<c:when test="${pageType=='modify' || pageType=='audit' || pageType=='auditDetail' }">
											<ul id="menu" class="play-select-title clearfix">
												<li class="current" onclick="settab(0)">选一</li>
												<li onclick="settab(1)">选二</li>
												<li onclick="settab(2)">选三</li>
												<li onclick="settab(3)">选四</li>
												<li onclick="settab(4)">选五</li>
												<li onclick="settab(5)">选六</li>
												<li onclick="settab(6)">选七</li>
												<li onclick="settab(7)">选八</li>
												<li onclick="settab(8)">趣味</li>
											</ul>
										</c:when>
										<c:otherwise>
											...
											<table class="table table-info table-border">
												...
												<tbody>
													...
													<c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
														<c:if test="${groupVar.gameGroupCode==22 }">
										...
										<li>
											<table class="table table-info table-border">
												...
												<tbody>
													...
													<c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
														<c:if test="${groupVar.gameGroupCode==23 }">
										...
										<li>
											<table class="table table-info table-border">
												...
												<tbody>
													...
													<c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
														<c:if test="${groupVar.gameGroupCode==24 }">
										...
										<li>
											<table class="table table-info table-border">
												...
												<tbody>
													...
													<c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
														<c:if test="${groupVar.gameGroupCode==25 }">
										...
										<li>
											<table class="table table-info table-border">
												...
												<tbody>
													...
													<c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
														<c:if test="${groupVar.gameGroupCode==26}">
										...
										<li>
											<table class="table table-info table-border">
												...
												<tbody>
													...
													<c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
														<c:if test="${groupVar.gameGroupCode==27}">
										...
										<li>
											<table class="table table-info table-border">
												...
												<tbody>
													...
													<c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
														<c:if test="${groupVar.gameGroupCode==28 }">
										...
										<li>
											<table class="table table-info table-border">
												...
												<tbody>
													...
													<c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
														<c:if test="${groupVar.gameGroupCode==29 }">
															<% int groupMethodCount8 = 0; %>
															<c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
																<c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
																<%groupMethodCount8++; %>
																</c:forEach>
															...
															<c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
																<c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
																	<tr>													
																		<c:if test="${setIndex.index==0 && helpIndex.index == 0}"><td rowspan="<%=groupMethodCount8%>">${groupVar.gameGroupCodeName }</td></c:if>
																		<c:if test="${helpIndex.index == 0}"><td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td></c:if>
																		<td>${helpVar.betMethodName }</td>
										...
										<li>
											<table class="table table-info table-border">
												...
												<tbody>
													...
													<c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
														<c:if test="${groupVar.gameGroupCode==18 }">
															<% int groupMethodCount9 = 0; %>
															<c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
																<c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
																<%groupMethodCount9++; %>
																</c:forEach>
															...
															<c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
																<c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
																	<tr>													
																		<c:if test="${setIndex.index==0 && helpIndex.index == 0}"><td rowspan="<%=groupMethodCount9%>">${groupVar.gameGroupCodeName }</td></c:if>
																		<c:if test="${helpIndex.index == 0}"><td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td></c:if>
																		<td>${helpVar.betMethodName }</td>
