...
<div class="col-crumbs">
    <div class="crumbs">
        <strong>当前位置：</strong><a href="${currentContextPath}/gameoa/lotteryList?lotteryId=&status=">游戏中心</a>><a
            href="${currentContextPath}/gameoa/lotteryList?lotteryId=&status="><spring:message code="gameCenter_caizhongxinxiliebiao" /></a>>
        <c:choose>
        ...
        <c:choose>
            ...
            <c:when test="${pageType=='audit' || checkStatus == 4}">
                <c:choose>
                    ...
                    <c:otherwise>
                        <td>
                            <div class="textarea w-6"><textarea readonly>${lotteryHelpDes}</textarea></div>
                        </td>
                    </c:otherwise>
                </c:choose>
            </c:when>
...
<c:if test="${lotteryId==99701}"><!-- 避免沒有lotteryHelpDes 修改會失敗 -->
 <div style="display:none">
 <textarea id="lotteryHelpDes" name="lotteryHelpDes">开奖周期说明六合彩</textarea>
 </div>
</c:if>
...
<c:choose>
    <c:when test="${pageType=='modify' || pageType=='audit' || pageType=='auditDetail' }">
        <ul id="menu" class="play-select-title clearfix">
            <c:if test="${lotteryId!=99107 && lotteryId!=99108 && lotteryId!=99109 && lotteryId!=99701  }">
                <li class="current" onclick="settab(0)">五星</li>
                <li onclick="settab(1)">四星</li>
                <li onclick="settab(2)">后三</li>
                <li onclick="settab(3)">中三</li>
                <li onclick="settab(4)">前三</li>
                <li onclick="settab(5)">后二</li>
                <li onclick="settab(6)">前二</li>
                <li onclick="settab(7)">一星</li>
            </c:if>
             <c:if test="${lotteryId==99107}">
                <li class="current" onclick="settab(0)">后三</li>
                <li onclick="settab(1)">后二</li>
                <li onclick="settab(2)">前二</li>
                <li onclick="settab(3)">一星</li>
            </c:if>
            <c:if test="${lotteryId==99108}">
                <li class="current" onclick="settab(0)">前三</li>
                <li onclick="settab(1)">后二</li>
                <li onclick="settab(2)">前二</li>
                <li onclick="settab(3)">一星</li>
            </c:if>
            <c:if test="${lotteryId==99109}">
                ...
                <li onclick="settab(1)">后二</li>
                <li onclick="settab(2)">前二</li>
                <li onclick="settab(3)">P5后二</li>
                <li onclick="settab(4)">P5一星</li>
            </c:if>
            <c:if test="${lotteryId==99701}">
                <li class="current" onclick="settab(0)">平码</li>
                <li onclick="settab(1)">特码</li>
                <li onclick="settab(2)">正特码</li>
                <li onclick="settab(3)">连码</li>
            </c:if>
        </ul>
    </c:when>
    <c:otherwise>
...
<div id="mainContent">
<!-- 五星 -->
<c:if test="${lotteryId!=99108 && lotteryId!=99109 && lotteryId!=99107}">
    ...
    <li>
        <table class="table table-info table-border">
            ...
            <c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
                ...
                <c:if test="${groupVar.gameGroupCode==10 }">
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount1%>">${groupVar.gameGroupCodeName }</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td>
                                </c:if>
                                ...
                                <c:choose>
                                    <c:when test="${pageType=='modify' }">
                                        <td>
                                            <div class="textarea w-6"><textarea
                                                    name="${groupVar.gameGroupCode }_${setVar.gameSetCode }_${helpVar.betMethodCode }_text">${helpVar.gamePromptDes }</textarea>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="textarea w-6"><textarea
                                                    name="${groupVar.gameGroupCode }_${setVar.gameSetCode }_${helpVar.betMethodCode }_text2">${helpVar.gameExamplesDes }</textarea>
                                            </div>
                                        </td>
                                    </c:when>
                                    <c:when test="${pageType=='audit' || checkStatus == 4 }">
                                            ...
                                            <c:when test="${helpVar.gamePromptDes_bak != null }">
                                                <td>
                                                    <div class="textarea textarea-mark-cont w-6">
                                                        ...
                                                        <div class="textarea-mark-old"
                                                             style="display:none;">${helpVar.gamePromptDes_bak }</div>
                                                    </div>
                                                </td>
                                            </c:when>
                                            <c:otherwise>
                                                <td>
                                                    <div class="textarea w-6"><textarea
                                                            readonly>${helpVar.gamePromptDes}</textarea></div>
                                                </td>
                                            </c:otherwise>
                                        </c:choose>
                                        <c:choose>
                                                ...
                                                <td>
                                                    <div class="textarea textarea-mark-cont w-6">
                                                     <div class="text input-mark" data-showtip="${helpVar.gameExamplesDes_bak }">${helpVar.gameExamplesDes}</div>
                                                        <div class="textarea-mark-old"
                                                             style="display:none;">${helpVar.gameExamplesDes_bak }</div>
                                                    </div>
                                                </td>
                                            </c:when>
                                            <c:otherwise>
                                                <td>
                                                    <div class="textarea w-6"><textarea
                                                            readonly>${helpVar.gameExamplesDes}</textarea></div>
                                                </td>
                                            </c:otherwise>
                                        </c:choose>
                                    </c:when>
                ...
                <!-- 超级2000 -->
                <c:if test="${groupVar.gameGroupCode==44 }">
                    <% int groupMethodCount1 = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCount1++; %>
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount1%>">${groupVar.gameGroupCodeName }_超级2000</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }_超级2000</td>
                                </c:if>
                                <td>${helpVar.betMethodName }_超级2000</td>
                ...
                <!-- 六合彩 正碼-->
                <c:if test="${groupVar.gameGroupCode==53 }">
                    <% int groupMethodCountZm = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCountZm++; %>
                        </c:forEach>
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCountZm%>">${groupVar.gameGroupCodeName }</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td>
                                </c:if>
...
<ul id="DivRules" style="display: none;" class="ui-form ui-tab-content ui-tab-content-current">
    <li>
        <table class="table table-info table-border">
            ...
            <c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
                <c:if test="${groupVar.gameGroupCode==11 }">
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount2%>">${groupVar.gameGroupCodeName }</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td>
                                </c:if>
                ...
                <!-- 超级2000 -->
                <c:if test="${groupVar.gameGroupCode==45 }">
                    <% int groupMethodCount2 = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCount2++; %>
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount2%>">${groupVar.gameGroupCodeName }_超级2000</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }_超级2000</td>
                                </c:if>
                ...
                <!-- 六合彩 特碼-->
                <c:if test="${groupVar.gameGroupCode==54 }">
                    <% int groupMethodCountTm = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCountTm++; %>
                        </c:forEach>
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCountTm%>">${groupVar.gameGroupCodeName }</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td>
                                </c:if>
...
<c:if test="${lotteryId!=99107 && lotteryId!=99108 && lotteryId!=99109}">
<ul id="DivRules" style="display: none;" class="ui-form ui-tab-content ui-tab-content-current">
...
<!-- 后三 -->
    <li>
        <table class="table table-info table-border">
            ...
            <c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
                <c:if test="${groupVar.gameGroupCode==13 }">
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount3%>">${groupVar.gameGroupCodeName }</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td>
                                </c:if>
                ...
                <!-- 超级2000 -->
                <c:if test="${groupVar.gameGroupCode==47 }">
                    <% int groupMethodCount3 = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCount3++; %>
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount3%>">${groupVar.gameGroupCodeName }_超级2000</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }_超级2000</td>
                                </c:if>
 				...
 				<!-- 六合彩 正特碼 -->
                <c:if test="${groupVar.gameGroupCode==55 }">
                    <% int groupMethodCountZtm = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCountZtm++; %>
                        </c:forEach>
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCountZtm%>">${groupVar.gameGroupCodeName }</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td>
                                </c:if>
...
<ul id="DivRules" style="display: none;" class="ui-form ui-tab-content ui-tab-content-current">
    <li>
        <table class="table table-info table-border">
            ...
            <c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
                <c:if test="${groupVar.gameGroupCode==33 }">
                    <% int groupMethodCount3 = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCount3++; %>
                ...
                <!-- 超级2000 -->
                <c:if test="${groupVar.gameGroupCode==51 }">
                    <% int groupMethodCount3 = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCount3++; %>
				 ...
				 <!-- 六合彩 連碼-->
                <c:if test="${groupVar.gameGroupCode==56 }">
                    <% int groupMethodCountLm = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCountLm++; %>
                        </c:forEach>
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCountLm%>">${groupVar.gameGroupCodeName }</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td>
                                </c:if>
...
<ul id="DivRules" class="ui-form ui-tab-content ui-tab-content-current">
    ...
    <li>
        <table class="table table-info table-border">
            ...
            <c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
                <c:if test="${groupVar.gameGroupCode==12 }">
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount4%>">${groupVar.gameGroupCodeName }</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td>
                                </c:if>
                ...
                <!-- 超级2000 -->
                 <c:if test="${groupVar.gameGroupCode==46 }">
                    <% int groupMethodCount4 = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCount4++; %>
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount4%>">${groupVar.gameGroupCodeName }_超级2000</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }_超级2000</td>
                                </c:if>
...
<ul id="DivRules" style="display: none;" class="ui-form ui-tab-content ui-tab-content-current">
    <li>
        <table class="table table-info table-border">
            ...
            <c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
                <c:if test="${groupVar.gameGroupCode==14 }">
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount5%>">${groupVar.gameGroupCodeName }</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td>
                                </c:if>
                ...
                <!-- 超级2000 -->
                 <c:if test="${groupVar.gameGroupCode==48 }">
                    <% int groupMethodCount5 = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCount5++; %>
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount5%>">${groupVar.gameGroupCodeName }_超级2000</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }_超级2000</td>
                                </c:if>
...
<ul id="DivRules" style="display: none;" class="ui-form ui-tab-content ui-tab-content-current">
    <li>
        <table class="table table-info table-border">
            ...
            <c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
                <c:if test="${groupVar.gameGroupCode==15 }">
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount6%>">${groupVar.gameGroupCodeName }</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td>
                                </c:if>
                ...
                <!-- 超级2000 -->
                <c:if test="${groupVar.gameGroupCode==49 }">
                    <% int groupMethodCount6 = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCount6++; %>
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount6%>">${groupVar.gameGroupCodeName }_超级2000</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }_超级2000</td>
                                </c:if>
...
<ul id="DivRules" style="display: none;" class="ui-form ui-tab-content ui-tab-content-current">
    <li>
        <table class="table table-info table-border">
            ...
            <c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
                <c:if test="${groupVar.gameGroupCode==30 }">
                    <% int groupMethodCount5 = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCount5++; %>
...
<ul id="DivRules" style="display: none;" class="ui-form ui-tab-content ui-tab-content-current">
    <li>
        <table class="table table-info table-border">
            ...
            <c:forEach var="groupVar" items="${strucs }" varStatus="groupIndex">
                <c:if test="${groupVar.gameGroupCode==16 || groupVar.gameGroupCode==31}">
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount7%>">${groupVar.gameGroupCodeName }</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }</td>
                                </c:if>
                ...
                <!-- 超级2000 -->
                <c:if test="${groupVar.gameGroupCode==50}">
                    <% int groupMethodCount7 = 0; %>
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <%groupMethodCount7++; %>
                    ...
                    <c:forEach var="setVar" items="${groupVar.setCodes }" varStatus="setIndex">
                        <c:forEach var="helpVar" items="${setVar.helpCodes }" varStatus="helpIndex">
                            <tr>
                                <c:if test="${setIndex.index==0 && helpIndex.index == 0}">
                                    <td rowspan="<%=groupMethodCount7%>">${groupVar.gameGroupCodeName }_超级2000</td>
                                </c:if>
                                <c:if test="${helpIndex.index == 0}">
                                    <td rowspan="${fn:length(setVar.helpCodes)}">${setVar.gameSetCodeName }_超级2000</td>
                                </c:if>
...
<table class="table table-info table-border">
    ...
    <c:choose>
        <c:when test="${pageType=='modify' }">
            <tr>
                <td class="text-center"><a class="btn btn-important " href="javascript:void(0);" id="J-Modify-Butt1">保存修改<b
                        class="btn-inner"></b></a></td>
            </tr>
        </c:when>
...
<style>
    .textarea-mark-cont, .textarea-mark-cont:hover {
