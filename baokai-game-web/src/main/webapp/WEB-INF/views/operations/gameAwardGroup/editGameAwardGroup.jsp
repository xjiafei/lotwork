...
<div id="tab_menu_id" style="display:none">awardGroupMenu</div>
							...
							<div class="">
								...
								<ul class="ui-search">
									<li>
										...
										<input type="hidden" id="lotteryId" name="gameAwardGroup.lotteryId" value="${lotteryId }"/>
									...
									<li>
										...
										<input type="text" class="input w-2" id="awardName" readonly value="${gameAward.awardGroupName}" name="gameAward.awardGroupName">
									</li>
									<li>
								...
								<table class="table table-info table-border" id="J-data-table">
									...
									<tbody>
										...
										<tr>
											<td colspan="7" class="text-center"><a class="btn btn-important" href="javascript:void(0);" id="J-SaveChanges">保存修改<b class="btn-inner"></b></a></td>
										</tr>
									</tbody>
								</table>
							</div>
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/operations/gameAward/editGameAwardGroup.js"></script>
</body>
