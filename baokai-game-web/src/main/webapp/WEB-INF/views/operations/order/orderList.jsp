...
<head>
		<title><spring:message code="gameCenter_fanganzhuihaoguanli" />-<spring:message code="gameCenter_fanganjilu" /></title>

</head>
<body>
			<div class="col-crumbs">
			<div class="crumbs">
				<strong>当前位置：</strong><a href="#">游戏中心</a>><spring:message code="gameCenter_fanganjilu" />
			</div>
			</div>
			<div class="col-content">
				<div class="col-main">
					<div class="main">
						...
						<form action="queryOrderList" method="post" id="J-search-form">
