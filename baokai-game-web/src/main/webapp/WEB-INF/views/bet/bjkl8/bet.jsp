...
<head>
	...
	<link rel="stylesheet" href="${staticFileContextPath}/static/images/game/bjkl8/bjkl8.css" />
...
<body>
	...
	<div class="header">
		<div class="g_33">
			<h1 class="logo">
				<a title="北京快乐8" href="#" >北京快乐8</a>
			</h1>
			<div class="deadline">
				<div class="deadline-text">
				<input id="J-lottery-info-currentIssue" type="hidden" autocomplete="off"/>
					第<strong id="J-lottery-info-number">----</strong>期<br />离投注截止还有
				</div>
			...
			<div class="lottery">
				<div class="lottery-text">
					第<strong id="J-lottery-info-lastnumber">----</strong>期<br />
					<a href="/game/chart/kl8/Quwei" target="_blank">开奖号码&gt;</a>
				</div>
				...
				<div class="lottery-info" id="lottery-info">和值=854(大,单)<br />盘面=下,奇</div>
				<div class="lottery-link">
					<a href="/game/chart/kl8/Quwei" class="chart" target="_blank">号码走势</a>
	...
	<div class="g_33 main">
					     ...
					     <c:if test="${!empty orders}">
							...
							<c:forEach items="${orders}" var="orderStruc" varStatus="status">
								<tr>
									...
									<td>  <c:choose><c:when test="${orderStruc.status == 1}">等待开奖</c:when>
		...
		<!-- 走势图开始 -->
		<div class="chart-section clearfix" id="J-chart-container" style="display:none">
			<div class="chart-table-k8" id="J-game-chart">
				
			</div>
			<div id="J-charts-area" class="charts-area">
...
<!-- loading开始 -->
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/bjkl8/game-bjkl8-sub.min.js" ></script>

	<script type="text/javascript" src="${currentContextPath}/gameBet/${lotteryCode}/config" ></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/bjkl8/phoenix.GameMethod.js"></script> 
	<script type="text/javascript" src="${staticFileContextPath}/static/js/bet/bjkl8.js"></script>
</body>
</html>
