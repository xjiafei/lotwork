...
REVISION HISTORY
------------------------------------------------------
2016.03.09 David Wu Changed : 統一tool bar 套用decorator模組介面切割為header、body，
							    並將共用選單交由  WEB-INFview/bet/layouts/betMain.jsp(遊戲頁面共用框架) 加載
...
<body>
	<div class="header">
		<div class="g_33">
			<h1 class="logo">
				<a title="时时彩" id="J-lottery-logo">时时彩</a>
			</h1>
			<div class="deadline">
				<div class="deadline-text">
				<input id="J-lottery-info-currentIssue" type="hidden" autocomplete="off"></input>
			...
			<div class="lottery">
				<div class="lottery-text">
					...
					<a href="/game/chart/${lotteryCode}/Wuxing"  target="_blank" >开奖号码&gt;</a>
				</div>
 ...
 class="info">游戏说明</a>
		...
		<div id="J-trace-panel" style="display: none;">
			...
			<div class="chase-tab">
				...
				<div class="chase-tab-content">
					...
					<div class="chase-btn">
						<input id="J-trace-builddetail" type="button" value="">
					</div>
	...
	<!-- 提交按钮开始 -->
	<div class="bet-btn">
		<input type="button" id="J-submit-order" value="">
	</div>
	<!-- 提交按钮结束 -->
	</div>
	...
	<%-- 統一 Tool Bar 變更 game-parent.js => game-parent.min.js   --%>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/game-parent.min.js" ></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/ssc/game-ssc-sub.min.js" ></script>
	<script type="text/javascript" src="${currentContextPath}/gameBet/${lotteryCode}/config?select2000=${select2000}" ></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/bet/bet.js"></script>
	<script type="text/javascript">
	
	$(document).on("click", "#brand2000click", function(){
	 	   var newwin = window.open(); 
		   newwin.location.assign("${currentContextPath}/info/2000info");
	});
