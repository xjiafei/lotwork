...
<head>
	...
	<link rel="stylesheet" href="${staticFileContextPath}/static/images/game/llssc/llssc.css" />
...
<body>
	...
	<div class="header">
		<div class="g_33">
			...
			<div class="deadline">
				<div class="deadline-text"><strong id="J-lottery-info-number">----</strong><br />第<strong id="J-lottery-info-amount">--</strong>期<br />截止时间</div>
			...
			<div class="lottery">
				<div class="lottery-text"><strong id="J-lottery-info-lastnumber">----</strong><br />第<strong id="J-lottery-info-lastamount">--</strong>期<br />开奖号码</div>
				...
				<div class="lottery-link">
					<a class="chart" target="_blank" href="/game/chart/${lotteryCode}/Wuxing">号码走势</a>
				</div>
			</div>
			<div class="deadline-video" style="display:none"></div>
		</div>
	</div>
	<!-- 开奖视频开始 -->
	...
	<div class="g_33 main">
		...
		<div class="play-section clearfix">
			<div class="program-chase">
				<a href="javascript:void(0);" class="more" id="J-more-orderData" target="_black">更多</a>
				<ul class="program-chase-title clearfix">
			...
			<div id="J-play-select" class="play-select">
				<div class="prompt">
					...
					<span class="method-tip">从三位各选1个或多个号码，选号与开奖号后三位按位一致即中1700元。</span>
		...
		<!-- 选球统计结束 -->
		<div class="number-section-arrow"></div>
		
		
		<div class="panel-section">
			<div class="panel-machine clearfix">
				<div class="panel-select">
					<ul id="J-balls-order-container">
					</ul>
				</div>
				<div class="panel-btn">
					<a href="javascript:void(0);" id="randomone" class="take-one">机选一注</a>
					<a href="javascript:void(0);" id="randomfive" class="take-five">机选五注</a>
					<a href="javascript:void(0);" id="restdata" class="empty-number">清空号码</a>
				</div>
			</div>
			<div class="panel-machine-arrow"></div>
			<ul class="bet-statistics">
			...
			<div class="bet-statistics-arrow"></div>
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/llssc/llssc/game-llssc-sub.min.js" ></script>

	<script type="text/javascript" src="${currentContextPath}/gameBet/${lotteryCode}/config" ></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/bet/llbet.js"></script>
