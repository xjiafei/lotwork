...
<body>
		...
		<div class="g_33">
			...
			<div class="lottery">
				<div class="lottery-text">
					...
					<a href="/game/chart/${lotteryCode}/Housan"  target="_blank" >开奖号码&gt;</a>
				</div>
				<div class="lottery-number" id="J-lottery-info-balls">
				<em></em> <em></em> <em></em>
				</div>
				<div class="lottery-link">
					<a href="/game/chart/${lotteryCode}/Housan"  target="_blank" class="chart"  class="chart">号码走势</a> <a href="${userContextPath}/help/goIndex" target="_blank"
						 class="info">游戏说明</a>
				</div>
			</div>
		</div>
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/shssl/ssl/game-ssl-sub.min.js" ></script>
