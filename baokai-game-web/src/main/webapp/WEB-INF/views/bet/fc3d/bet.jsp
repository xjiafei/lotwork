...
<head>
    ...
    <link rel="stylesheet" href="${staticFileContextPath}/static/images/game/fc3d/fc3d.css" />
...
<div class="header">
    <div class="g_33">
        <h1 class="logo"><a title="福彩3D" href="#">福彩3D</a></h1>
        <div class="deadline">
        ...
        <div class="lottery">
            <div class="lottery-text">第<strong id="J-lottery-info-lastnumber">----</strong>期<br />
                <a href="/game/chart/d3/Qiansan" `>开奖号码&gt;</a>
            </div>
            ...
            <div class="lottery-link">
                <a href="/game/chart/d3/Qiansan" target="_blank" class="chart">号码走势</a>
                <a href="${userContextPath}/help/queryLotterylHelp?cateId2=26&cate2Name=${lotteryName}" target="_blank" class="info">游戏说明</a>
            </div>
        </div>
    </div>
</div>
            ...
            <li>
                <table class="program-chase-table"  id="program-user-orders" >
                    ...
                    <c:if test="${empty orders}">
                        <td colspan="5">您最近50天暂时没有投注记录！</td>
                    </c:if>
                    <c:if test="${!empty orders}">
                        <tbody >
            ...
            <li>
                <table class="program-chase-table"  id="program-user-plans" >
                    ...
                    <c:if test="${empty plans}">
                        <td colspan="5">您最近50天暂时没有追号记录！</td>
                    </c:if>
                    <c:if test="${!empty plans}">
                        <tbody >
...
<!-- 底部结束 -->
    ...
    <script type="text/javascript" src="${staticFileContextPath}/static/js/game/fc3d/game-fc3d-sub.min.js"></script>
    <script type="text/javascript" src="${currentContextPath}/gameBet/${lotteryCode}/config" ></script>
    <script type="text/javascript" src="${staticFileContextPath}/static/js/bet/fc3d.js" ></script>
