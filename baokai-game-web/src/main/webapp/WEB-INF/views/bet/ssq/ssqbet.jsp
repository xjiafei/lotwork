...
<head>
	...
	<link rel="stylesheet" href="${staticFileContextPath}/static/images/game/ssq/ssq.css" />
...
<div class="prize-poll">
		...
		<div class="prize-poll-text">
			<span>当前奖池</span>
			<strong><em>232,233,000</em>元</strong>
</div>
	</div>
	<!-- header start -->
	<div class="header">
		<div class="g_33">
			<h1 class="logo"><a title="双色球" href="#">双色球</a></h1>
			<div class="deadline">
				<div class="deadline-text">第<strong id="J-lottery-info-number">13032442</strong>期<br />离投注截止还有</div>
			...
			<div class="lottery">
				<div class="lottery-text">第<strong id="J-lottery-info-lastnumber">13032442-021</strong>期<br /><a href="/game/chart/${lotteryCode}/ssq_basic" target="_blank">开奖号码&gt;</a></div>
				<div class="lottery-number" id="J-lottery-info-balls">
					...
					<em>1</em>
					<em>2</em>
					<em class="blue-ball">7</em>
				</div>
				<div class="lottery-link">
					<a href="/game/chart/${lotteryCode}/ssq_basic" target="_blank" class="chart">号码走势</a>
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/ssq/game-ssq-sub.min.js" ></script>
	<script type="text/javascript" src="${currentContextPath}/gameBet/${lotteryCode}/config" ></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/bet/ssqbet.js"></script>
</body>
