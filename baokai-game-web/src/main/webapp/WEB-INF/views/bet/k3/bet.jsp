...
<head>
    ...
    <link rel="stylesheet" href="${staticFileContextPath}/static/images/game/k3/k3.css" />
...
<div class="header">
		<div class="g_33">
			<h1 class="logo"><a title="江苏快3" href="#">江苏快3</a></h1>
			<div class="deadline" style="margin-left:-25px;">
				<div class="deadline-text">第<strong id="J-lottery-info-number">20130320-012</strong>期<br />离投注截止还有</div>
			...
			<div class="lottery" style="margin-left:10px;">
				<div class="lottery-text">第<strong id="J-lottery-info-lastnumber">20130320-012</strong>期<br /><a href="/game/chart/${lotteryCode}/chart" target="_blank">开奖号码&gt;</a></div>
				...
				<div class="lottery-info">
					和值：<strong id="">9</strong><br />形态：<em>小</em><em>单</em>
				</div>
				<div class="lottery-link">
					<a href="${chartContextPath}/game/chart/${lotteryCode}/chart" target="_blank" class="chart">号码走势</a>
					<a href="${userContextPath}/help/queryLotteryDetail?helpId=1123" target="_blank" class="info">游戏说明</a>
				</div>
			</div>
			<div class="lottery" style="width:70px;margin-left:10px;">
			  <div class="lottery-text" style="margin-top:20px;"><a href="/gameBet/jsdice/" target="_blank">骰宝入口</a></div>
			</div>
		</div>
	</div>
	<!-- header end -->
	<div class="g_33 main">
		...
		<div class="play-section">
			...
			<div id="J-play-select" class="play-select">
				...
				<div class="ico-easy"></div>
			</div>
		</div>
		<!-- 走势图开始 -->	
		<div class="chart-section" id="J-game-chart" style="display:none"></div>
		<!-- 走势图结束 -->
		<!-- 选球统计开始 -->
		<div class="number-section">
			...
			<div id="J-balls-statistics-panel">
				<ul class="bet-statistics">
					...
					<select id="J-balls-statistics-moneyUnit" class="J-ui-select" style="display:none;">
					...
					&nbsp;&nbsp; 奖金
					<select id="J-select-rebate" class="J-ui-select" style="display:none;">
					</select>
					</li>
...
<!-- loading开始 -->
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/k3/game-k3-sub.min.js" ></script>

	<script type="text/javascript" src="${currentContextPath}/gameBet/${lotteryCode}/config" ></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/bet/k3bet.js" ></script>
</body>
</html>
