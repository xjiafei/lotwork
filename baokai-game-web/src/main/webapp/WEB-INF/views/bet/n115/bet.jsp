...
<head>
	...
	<link rel="stylesheet" href="${staticFileContextPath}/static/images/game/n115/n115.css" />
</head>
<body>
	<div class="header">
		<div class="g_33">
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/n115/game-n115-sub.min.js"></script>
	<script type="text/javascript" src="${currentContextPath}/gameBet/${lotteryCode}/config"></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/bet/n115bet.js"></script>
</body>
</html>