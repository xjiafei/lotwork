...
<head>
	...
	<link rel="stylesheet" href="${staticFileContextPath}/static/images/game/mmc115/mmc.css" />
	<link rel="stylesheet" href="${staticFileContextPath}/static/images/game/mmc115/jquery.jscrollpane.css">

<title>秒开11选5</title>
</head>
<body class="bg-body">
    <input type="hidden" id="mmcBetKey" value="${mmcBetKey}">
		...
		<div class="header">
			<div class="ball_number_area">
				<div class="lamp">
					...
					<img src="${staticFileContextPath}/static/images/game/mmc115/marquee_a.gif" data-imgholder="${staticFileContextPath}/static/images/game/mmc/marquee_b.gif" alt="">
				</div>
				<div id="flipball"></div>
			...
			<div class="lottery_draw" data-simulation="records">
				<div class="lottery_wrap">
					<ul data-records="wrap" style="height: 0px; margin-top: 0px;">
					 <c:forEach items="${nums}" var="record">
					<li><span class="num_${record[0] }">${record[0] }</span><span class="num_${record[1] }">${record[1] }</span><span class="num_${record[2] }">${record[2] }</span><span class="num_${record[3] }">${record[3] }</span><span class="num_${record[4] }">${record[4] }</span></li>
				...
				<div class="prev_next">
					...
					<span class="next ">&lsaquo;</span>
				</div>
			</div>
			<a href="http://em.haodeaili.com/game/chart/slmmc/Wuxing" target="_blank" class="more_links">更多记录</a>
			<a href="${user.resources.path}/game/chart/${lotteryCode}/Wuxing" target="_blank" class="more_links">更多记录</a>
	...
	<div class="dialog" id="dl_loading" style="display: none;"></div><div class="dialog" id="win_prize" style="display: none;"> 							<span class="prize_icon"></span> 							<p>恭喜您，中奖<span class="highlight" data-amount=""></span>元</p> 						</div><div class="dialog" id="draw_times" style="display: none;"> 							<p>第<span class="highlight" data-times=""></span>次开奖</p> 						</div><div class="dialog" id="no_prize" style="display: none;"> 							<div class="result_bg"></div> 						</div><div class="dialog" id="prize_result" style="display: none;"> 							<div class="result_bg"></div> 							<div class="result_cont">总计<span class="highlight" data-result="">23,456,789.00</span>元</div> 						</div><div class="dialog" id="dl_normal" style="display: none;"> 							<p data-content="">开奖完成</p> 						</div>
	
<div class="j-ui-tip j-ui-tip-close j-ui-tip-yellow j-ui-tip-t" style="display:none;position:absolute;left:0;top:0;z-index:500;"><i class="sj sj-t"></i><i class="sj sj-r"></i><i class="sj sj-b"></i><i class="sj sj-l"></i><span class="ui-tip-text"><h4><i class="close">ⅹ</i>温馨提示</h4><p>平台功能小调整，默认勾选中奖后停止追号</p></span></div><div class="j-ui-miniwindow pop w-9" style="z-index: 700; position: fixed; display: none;"><div class="hd"><i class="close closeBtn"></i><span class="title">提示</span></div><div class="bd"></div><a style="display:none" href="javascript:void(0);" class="btn confirm">确 认<b class="btn-inner"></b></a><a style="display:none" href="javascript:void(0);" class="btn cancel">取 消<b class="btn-inner"></b></a><a href="javascript:void(0);" style="display:none" class="btn closeTip">关 闭<b class="btn-inner"></b></a></div><div class="j-ui-mask" style="display: none; position: absolute; left: 0px; top: 0px; opacity: 0.2; z-index: 600; background-color: rgb(51, 51, 51);"></div><div class="j-ui-mask" style="display: none; position: absolute; left: 0px; top: 0px; opacity: 0.2; z-index: 600; background-color: rgb(51, 51, 51);"></div><div class="j-ui-mask" style="display: none; position: absolute; left: 0px; top: 0px; opacity: 0.2; z-index: 600; background-color: rgb(51, 51, 51);"></div>
<script type="text/javascript">
	...
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/game-parent.js" ></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/mmc115/phoenix.MMC.GameStatistics.js"></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/mmc115/phoenix.MMC.GameOrder.js"></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/n115/game-n115-sub.js"></script>
	<script type="text/javascript" src="${currentContextPath}/gameBet/${lotteryCode}/config" ></script>
	<%-- <script type="text/javascript" src="${staticFileContextPath}/static/js/game/mmc115/config.js"></script> --%>
	
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/mmc115/mmc_utils.js"></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/game/mmc115/phoenix.Games.MMC.GameBellMethod.js" ></script>
	<script type="text/javascript" src="${staticFileContextPath}/static/js/bet/mmcbet115.js"></script>
