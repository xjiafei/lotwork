...
<head>
    ...
    <link rel="stylesheet" href="${staticFileContextPath}/static/images/game/p5/p5.css" />
...
<div class="header">
    <div class="g_33">
        ...
        <div class="deadline">
            <div class="deadline-text">第<strong id="J-lottery-info-number">----</strong>期<br />离投注截止还有</div>
        ...
        <div class="lottery">
            <div class="lottery-text">第<strong id="J-lottery-info-lastnumber">----</strong>期<br />
                <a href="/game/chart/${lotteryCode}/p5chart" target="_blank">开奖号码&gt;</a>
            </div>
            ...
            <div class="lottery-link">
                <a href="/game/chart/${lotteryCode}/p5chart" target="_blank" class="chart">号码走势</a>
...
<!-- 底部结束 -->
    ...
    <script type="text/javascript" src="${staticFileContextPath}/static/js/game/p5/game-p5-sub.min.js" ></script>
    <script type="text/javascript" src="${currentContextPath}/gameBet/${lotteryCode}/config" ></script>
    <script type="text/javascript" src="${staticFileContextPath}/static/js/bet/p5.js" ></script>
