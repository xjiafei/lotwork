...
<script type="text/javascript">
    ...
    var userName = '${userName}';							<%-- user name --%>
   	var indexServer ='${userContextPath}';//php servr		<%-- php server url 首頁--%>
    ...
    var bannerlogotitle='首页'; //bannerlogotitle 的文字			<%-- banner logo attribute : title Banner logo的文字--%>
    var bannerlogohref=userServer + "/index";					<%-- banner logo attribute : href  Banner logo的超連結--%>
    var userClassId = "J-user-panel";							<%-- user panel class id 使用者選單--%>			
    var msgClassId = "J-msg-panel";								<%-- message panel class id 站內信--%>
...
<t:if test="${userlvl!=-1&&isAllZero!=0}"><%-- get available user menu 取得使用者選單--%> 
	<script type="text/javascript">		
