...
(function(host, GameMethod, undefined){
	var defConfig = {
		name:'erbutonghao.biaozhun.dantuotouzhu',
		//玩法提示
		tips:'快三二不同号胆拖玩法',
		//选号实例
		exampleTip: '快三二不同号胆拖玩法范例'
	},
	lastBallNum = 0,
	Games = host.Games,
	...
	var pros = {
		...
		checkBallIsComplete: function(){
			...
			if(danBallLength == 1 && tuoBallLength >= 1){
	...
	var html_row = [];
			...
			html_row.push('</div>');
			html_row.push('<ul class="ball-content erbutonghao-dantuo">');
