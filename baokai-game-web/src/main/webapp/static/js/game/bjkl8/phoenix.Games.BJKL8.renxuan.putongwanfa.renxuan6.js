...
(function(host, GameMethod, undefined){
	var defConfig = {
		//名称
		name:'renxuan.putongwanfa.renxuan6',
		//玩法提示
	...
	var pros = {
		init:function(cfg){
			...
			//console.log(me.combine([1,2,3,4,5,6,7],6).length);
		...
		showSelectResult: function(){
			var me = this,
				...
				//超出限制范围
				if(currentSelectNum < 6 || currentSelectNum > 8){
				...
				var html = me.ballsResultCharts({
					...
					'money': {'1' : 1000.00, '2': 70.00, '3': 10.00, '4': 6.00}
				});
		...
		resetChartsResult: function(){
			var me = this,
				...
				html = '<div class="ball-table-title">您选择的号码可能中奖结果如下：</div><table cellspacing="1" width="100%"><tbody><tr><th colspan="8">玩法：任选6　　　投注号码数：0</th></tr><tr><td>每注奖金</td><td>1000.00</td><td>70.00</td><td>10.00</td><td>6.00</td><td></td><td></td><td></td></tr><tr><td>中奖号码数</td><td>选6中6</td><td>选6中5</td><td>选6中4</td><td>选6中3</td><td>未中奖</td><td>总注数</td><td>总奖金</td></tr><tr><td>中0个号码</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td>0</td><td style="text-align:center">0</td></tr></tbody></table>';
