	...
	function Lottery() {
		...
		this.dialogMarkup = {
			...
			'win': '<div class="dialog" id="win_prize"> \
							...
							<p>恭喜您中了<span class="highlight" data-num></span>注，总金额<span class="highlight" data-amount></span>元</p> \
						</div>',
			...
			'result': '<div class="dialog" id="prize_result"> \
							<div class="result_bg"></div> \
							<div class="result_cont"><span class="highlight" data-result>23,456,789.00</span></div> \
						</div>',
	...
	(function(host, Event, name, undefined) {
		...
		var pros = {
			...
			isContinuous: function() {
				...
				return (betData['continuousPeriod'] > 1) ? true : false;
			},
			...
			continuousBets: function(r) {
				...
				//如果多次开奖过程中
				//出现单次失败现象则停止
				if (Number(r['isSuccess']) === 0) {
					//console.log(me.getSaveCompletePeriod());
				}
