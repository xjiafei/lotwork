...
(function(host, GameMethod, undefined){
	...
	var html_row = [];
			...
			html_row.push('<div class="ball-control">');
				...
				html_row.push('<a data-param="action=batchSetBall&row=<#=row#>&bound=big&start=2" href="javascript:void(0);">大</a>');
				html_row.push('<a data-param="action=batchSetBall&row=<#=row#>&bound=small&start=2" href="javascript:void(0);">小</a>');
