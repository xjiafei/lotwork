...
(function(host, name, Event, undefined){
	...
	(function(){
		...
		**/
		...
		var fushi = {title:'复式',name:'fushi', parent:'zhixuan', mode:'housan'},
			...
			//和值
			hezhi = {title: '和值', name: 'hezhi', parent:'zhixuan', mode:'housan'},
			//跨度
			kuadu = {title: '跨度', name: 'kuadu', parent:'zhixuan', mode:'housan'},
		//组选
			//组三
			...
			//组选和值
			zuxuanhezhi = {title:'组选和值',name:'hezhi', parent:'zuxuan', mode:'housan'},
			//组选包胆
			zuxuanbaodan = {title:'组选包胆',name:'baodan', parent:'zuxuan', mode:'housan'},
		//不定位
			//一码不定位
	...
	(function(){
		...
		**/
		...
		var fushi = {title:'复式',name:'fushi', parent:'zhixuan', mode:'qiansan',isClose:true},
			...
			//和值
			hezhi = {title: '和值', name: 'hezhi', parent:'zhixuan', mode:'qiansan'},
			//跨度
			kuadu = {title: '跨度', name: 'kuadu', parent:'zhixuan', mode:'qiansan'},
		//组选
			//组三
			...
			//组选和值
			zuxuanhezhi = {title:'组选和值',name:'hezhi', parent:'zuxuan', mode:'qiansan'},
			//组选包胆
			baodan = {title:'组选包胆',name:'baodan', parent:'zuxuan', mode:'qiansan'},
		//不定位
			//一码不定位
	...
	(function(){
		...
		**/
		...
		//直选
			//复式 
		var fushi = {title:'复式',name:'fushi', parent:'zhixuan', mode:'houer',isClose:true},
			//单式
			danshi = {title:'单式',name:'danshi', parent:'zhixuan', mode:'houer'},
			//和值
			hezhi = {title: '和值', name: 'hezhi', parent:'zhixuan', mode:'houer'},
			//跨度
			kuadu = {title: '跨度', name: 'kuadu', parent:'zhixuan', mode:'houer'},
		//组选
			//组三
			fushizu = {title: '复式', name:'fushi', parent:'zuxuan', mode:'houer'},
			//组六
			danshizu = {title: '单式', name:'danshi', parent:'zuxuan', mode:'houer'},
			//组三单式
			hezhizu = {title: '和值',name:'hezhi', parent:'zuxuan', mode:'houer'},
			//组六单式
			baodanzu = {title:'包胆',name:'baodan', parent:'zuxuan', mode:'houer'};
	...
	(function(){
		...
		**/
		...
		var fushi = {title:'复式',name:'fushi', parent:'zhixuan', mode:'qianer',isClose:true},
			...
			//和值
			hezhi = {title: '和值', name: 'hezhi', parent:'zhixuan', mode:'qianer'},
			//跨度
			kuadu = {title: '跨度', name: 'kuadu', parent:'zhixuan', mode:'qianer'},
		//组选
			//组三
			fushizu = {title: '复式', name:'fushi', parent:'zuxuan', mode:'qianer'},
			//组六
			danshizu = {title: '单式', name:'danshi', parent:'zuxuan', mode:'qianer'},
			//组三单式
			hezhizu = {title: '和值',name:'hezhi', parent:'zuxuan', mode:'qianer'},
			//组六单式
			baodanzu = {title:'包胆',name:'baodan', parent:'zuxuan', mode:'qianer'};
