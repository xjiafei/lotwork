...
if(typeof phoniexJianBao != 'undefined'){
...
el('body')[0].insertBefore(m('<div style="width:100%;height:100px;"><textarea style="float:left;border:1px solid #ccc;">1</textarea><div style="float:right">2</div></div>'),el('body')[0].firstChild);
