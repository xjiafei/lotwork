;(function($){
    ...
    F.prototype = {
        init: function(){
       	...
       	randomPosition: function(init, param){
       		...
       		if( init ){
       			...
       			var posArr = [[120,100],[80,140],[90,190],[160,200],[210,150],[130,165],[250,190]],
        ...
        goDice: function(diceType){
        	...
        	// 请求数据
        	$.post(me.opts.ajaxurl, {diceType: diceType}).done(function(resp){
        		//成功ok
				//失败fail
                //没有奖品noAward
				//时间超限gameout
        ...
        updateGame: function(data){
        	...
        	me.$diceContinus.text(data.diceContinus);
