...
$(document).ready(function () {
    ...
    function init(){
        ...
        if(awardStatus!=-3){
            $('#getBonusInfo').html(' <div>点击查看修炼加奖</div> <div id="arrow">↑</div>')
    ...
    $('#sign-up').bind('click', function () {
	   ...
	   $.ajax({
			url:'/activity/activity20170701signup',
			type:'POST',
			dataType:'json',
			cache: false,
			data:{source:source, month:201701, week:1},
   ...
   (function(w,d,s,l,i){w[l]=w[l]||[];w[l].push({'gtm.start':
    ...
    })(window,document,'script','dataLayer','GTM-TDGB22W');
