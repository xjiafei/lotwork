function signUp(){
	...
	$.ajax({
		url:'/activity/signup20161203',
		type:'POST',
		dataType:'json',
		cache: false,
		data:{source:source, week:3 ,month:201612},
...
function querySignUp(){
	...
	$.ajax({
		url:'/activity/querysignup20161203',
		type:'POST',
		dataType:'json',
		cache: false,
		data:{source:source, month:201612, week:3, actId:20161203},
		success:function(data){
			if(data == 0 ){   //可以報名
