function signUp(){
	...
	$.ajax({
		url:'/activitymb/signup20161202',
		type:'POST',
		dataType:'json',
		cache: false,
		 data:{source:source, month:201612, week:2, token : $("#tokenValue").val()}, 
...
function querySignUp(){
	...
	$.ajax({
		url:'/activitymb/querysignup20161202',
		type:'POST',
		dataType:'json',
		cache: false,
		data:{source:source, month:201612, week:2, actId:20161202,token : $("#tokenValue").val()},
		success:function(data){
			if(data == 0 ){   //可以報名
