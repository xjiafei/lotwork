...
$(function(){
  ...
  function redbow3chekbets () {
	  //讀取數值
	  $.ajax({
		url: '/activitymb/redbow3chekbets',
		dataType: 'json',
		type:'POST',
		cache: false,
  ...
  function show_puzzle(step)
  {
    ...
    {
      $(".pf,.pb").hide();
      $(".phone_body").css("background","url("+$("#imgPath").val()+"/images/activity/2016_NovRedBow/activity3mb/images/full.png)no-repeat center top");
