...
function febSecondSignUp(){
	...
	$.ajax({
		url:'/activitymb/febsecondsignup',
		type:'POST',
		dataType:'json',
		cache: false,
		data:{source:source ,month:201702 ,token : $("#token").val()},
...
function query20170202SignUp(){
	...
	$.ajax({
		url:'/activitymb/query20170202signup',
		type:'POST',
		dataType:'json',
		cache: false,
		data:{source:source, month:201702 ,token : $("#token").val()},
...
function query20170203SignUp(){
	...
	$.ajax({
		url:'/activitymb/query20170203signup',
		type:'POST',
		dataType:'json',
		cache: false,
		data:{source:source, month:201702 ,token : $("#token").val()},
