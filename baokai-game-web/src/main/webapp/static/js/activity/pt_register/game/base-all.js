...
;(function(host, name, Event, $, undefined){
	...
	defConfig = {
		//点击按钮
		confirmButtonText : 'ui-js-btn-confirm',
		//取消按钮
	...
	var pros = {
		init:function(cfg){
			...
			me.dom = $('<div class="j-ui-miniwindow '+ cfg.cls +'" style="z-index:'+ cfg.zIndex +';position:'+ position +';display:none;"><div class="hd"><i class="close closeBtn"></i><span class="title">提示</span></div><div class="bd"></div><a href="javascript:void(0);" class="btn btn-important ui-js-btn-confirm">确 认<b class="btn-inner"></b></a><a href="javascript:void(0);" class="btn ui-js-btn-cancel">取 消<b class="btn-inner"></b></a><a href="javascript:void(0);" class="btn ui-js-btn-closetip">关 闭<b class="btn-inner"></b></a></div>').appendTo('body');
			me.effectShow = cfg.effectShow;
			me.effectHide = cfg.effectHide;
