    ...
    F.prototype = {
        init: function() {
            ...
            oLi.on('click',function(){
                var n = $(this).index();
                if(me.opts.setNum && (n >= me.opts.setNum) ){
                    me.opts.setNumCallback($(this));
                }else {
                    me.tab(n);
                }
            });
            ...
            this.opts.setNum && oLi.eq(this.opts.setNum-1).trigger('click');
        },
        play: function(){
            var box = this.$t;
