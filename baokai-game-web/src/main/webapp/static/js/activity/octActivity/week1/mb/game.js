    ...
    F.prototype = {
        ...
        jpMove: function(){
            ...
            this.moveTimer = setInterval(function(){
                ...
                _this.$j3.css({"left":left/100+'rem'});
            },400);
        },
        stopMove: function(){
            var _this = this;
        ...
        showLine: function(){
            var lineMap = [2000,50000,100000,200000],
                widthMap = [0,110,142,168,205],
                leftMap = [0,110,252,420,625],
            ...
            if(amount >= lineMap[3]){
                ...
                this.$tips.show().html(_this.configData['leftAmount']).css({'left':left/100+'rem'});
            }
            this.$line.css({'width':left/100+'rem'});
