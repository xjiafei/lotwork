...
function query(pageNo){
	...
	if(groupv==''){
		$("#J-form").attr('action',baseUrl+'/adAdmin/queryReviewAdPage?isAll=false');
	}else{
		$("#J-form").attr('action',baseUrl+'/adAdmin/queryReviewAdPage?isAll=false');
	}
	$("#pageForm").val(pageNo);
...
$(document).ready(function(){
	...
	$('#J-button-passall').click(function(){
		...
		Wd.show({
			...
			confirmFun:function(){
				$.ajax({
					url:baseUrl+'/adAdmin/reviewAdvert',
					dataType:'json',
					data:'ids='+result+'&status='+2,
					type:'post',
					success:function(data){
						if(data.status == 1){
							Wd.hide();
		...
		Wd.show({
			...
			confirmFun:function(){
				...
				$.ajax({
					url:baseUrl+'/adAdmin/reviewAdvert',
					dataType:'json',
					data:'ids='+result+'&status='+3+'&memo='+text,
					type:'post',
					success:function(data){
						if(data.status == 1){
							Wd.hide();
		...
		Wd.show({
			...
			confirmFun:function(){
				...
				$.ajax({
					url:baseUrl+'/adAdmin/reviewAdvert',
					dataType:'json',
					data:'ids='+id+'&status='+3+'&memo='+text,
					type:'post',
					success:function(data){
						if(data.status == 1){
							Wd.hide();
